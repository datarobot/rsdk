...
#' @docType class
#' @title PrimeModelDetailsRetrieveResponse
#'
#' @description PrimeModelDetailsRetrieveResponse Class
#'
...
#'
#' @field ruleCount  integer the number of rules used to create this model
#'
#' @field rulesetId  integer the ID of the ruleset this model uses
#'
#' @field samplePct  numeric the percentage of the dataset used in training the model
#'
#' @field score  numeric the validation score of the models ruleset
#'
...
#' @export
PrimeModelDetailsRetrieveResponse <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(blueprintId = NULL, featurelistId = NULL, featurelistName = NULL, id = NULL, isFrozen = NULL, isStarred = NULL, linkFunction = NULL, metrics = NULL, modelCategory = NULL, modelFamily = NULL, modelType = NULL, monotonicDecreasingFeaturelistId = NULL, monotonicIncreasingFeaturelistId = NULL, parentModelId = NULL, predictionThreshold = NULL, predictionThresholdReadOnly = NULL, processes = NULL, projectId = NULL, ruleCount = NULL, rulesetId = NULL, samplePct = NULL, score = NULL, supportsComposableMl = NULL, supportsMonotonicConstraints = NULL, trainingDuration = NULL, trainingEndDate = NULL, trainingRowCount = NULL, trainingStartDate = NULL) {
  ...
  public = list(
    ...
    #' @param ruleCount the number of rules used to create this model
    #' @param rulesetId the ID of the ruleset this model uses
    #' @param samplePct the percentage of the dataset used in training the model
    #' @param score the validation score of the models ruleset
    ...
    initialize = function(`blueprintId` = NULL, `featurelistId` = NULL, `featurelistName` = NULL, `id` = NULL, `isFrozen` = NULL, `isStarred` = NULL, `linkFunction` = NULL, `metrics` = NULL, `modelCategory` = NULL, `modelFamily` = NULL, `modelType` = NULL, `monotonicDecreasingFeaturelistId` = NULL, `monotonicIncreasingFeaturelistId` = NULL, `parentModelId` = NULL, `predictionThreshold` = NULL, `predictionThresholdReadOnly` = NULL, `processes` = NULL, `projectId` = NULL, `ruleCount` = NULL, `rulesetId` = NULL, `samplePct` = NULL, `score` = NULL, `supportsComposableMl` = NULL, `supportsMonotonicConstraints` = NULL, `trainingDuration` = NULL, `trainingEndDate` = NULL, `trainingRowCount` = NULL, `trainingStartDate` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`blueprintId`, `featurelistId`, `featurelistName`, `id`, `isFrozen`, `isStarred`, `linkFunction`, `metrics`, `modelCategory`, `modelFamily`, `modelType`, `monotonicDecreasingFeaturelistId`, `monotonicIncreasingFeaturelistId`, `parentModelId`, `predictionThreshold`, `predictionThresholdReadOnly`, `processes`, `projectId`, `ruleCount`, `rulesetId`, `samplePct`, `score`, `supportsComposableMl`, `supportsMonotonicConstraints`, `trainingDuration`, `trainingEndDate`, `trainingRowCount`, `trainingStartDate`)
      if (validateParams) {
        lapply(requiredProps, missing)
        private$validateProps(blueprintId, featurelistId, featurelistName, id, isFrozen, isStarred, linkFunction, metrics, modelCategory, modelFamily, modelType, monotonicDecreasingFeaturelistId, monotonicIncreasingFeaturelistId, parentModelId, predictionThreshold, predictionThresholdReadOnly, processes, projectId, ruleCount, rulesetId, samplePct, score, supportsComposableMl, supportsMonotonicConstraints, trainingDuration, trainingEndDate, trainingRowCount, trainingStartDate)
      }
    ...
    validate = function() {
      props <- list(blueprintId = self$`blueprintId`, featurelistId = self$`featurelistId`, featurelistName = self$`featurelistName`, id = self$`id`, isFrozen = self$`isFrozen`, isStarred = self$`isStarred`, linkFunction = self$`linkFunction`, metrics = self$`metrics`, modelCategory = self$`modelCategory`, modelFamily = self$`modelFamily`, modelType = self$`modelType`, monotonicDecreasingFeaturelistId = self$`monotonicDecreasingFeaturelistId`, monotonicIncreasingFeaturelistId = self$`monotonicIncreasingFeaturelistId`, parentModelId = self$`parentModelId`, predictionThreshold = self$`predictionThreshold`, predictionThresholdReadOnly = self$`predictionThresholdReadOnly`, processes = self$`processes`, projectId = self$`projectId`, ruleCount = self$`ruleCount`, rulesetId = self$`rulesetId`, samplePct = self$`samplePct`, score = self$`score`, supportsComposableMl = self$`supportsComposableMl`, supportsMonotonicConstraints = self$`supportsMonotonicConstraints`, trainingDuration = self$`trainingDuration`, trainingEndDate = self$`trainingEndDate`, trainingRowCount = self$`trainingRowCount`, trainingStartDate = self$`trainingStartDate`)
    ...
    #' @param PrimeModelDetailsRetrieveResponseJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(PrimeModelDetailsRetrieveResponseJson, validateParams = FALSE) {
      PrimeModelDetailsRetrieveResponseObject <- jsonlite::fromJSON(PrimeModelDetailsRetrieveResponseJson)
      self$`blueprintId` <- PrimeModelDetailsRetrieveResponseObject$`blueprintId`
      self$`featurelistId` <- PrimeModelDetailsRetrieveResponseObject$`featurelistId`
      self$`featurelistName` <- PrimeModelDetailsRetrieveResponseObject$`featurelistName`
      self$`id` <- PrimeModelDetailsRetrieveResponseObject$`id`
      self$`isFrozen` <- PrimeModelDetailsRetrieveResponseObject$`isFrozen`
      self$`isStarred` <- PrimeModelDetailsRetrieveResponseObject$`isStarred`
      self$`linkFunction` <- PrimeModelDetailsRetrieveResponseObject$`linkFunction`
      self$`metrics` <- PrimeModelDetailsRetrieveResponseObject$`metrics`
      self$`modelCategory` <- PrimeModelDetailsRetrieveResponseObject$`modelCategory`
      self$`modelFamily` <- PrimeModelDetailsRetrieveResponseObject$`modelFamily`
      self$`modelType` <- PrimeModelDetailsRetrieveResponseObject$`modelType`
      self$`monotonicDecreasingFeaturelistId` <- PrimeModelDetailsRetrieveResponseObject$`monotonicDecreasingFeaturelistId`
      self$`monotonicIncreasingFeaturelistId` <- PrimeModelDetailsRetrieveResponseObject$`monotonicIncreasingFeaturelistId`
      self$`parentModelId` <- PrimeModelDetailsRetrieveResponseObject$`parentModelId`
      self$`predictionThreshold` <- PrimeModelDetailsRetrieveResponseObject$`predictionThreshold`
      self$`predictionThresholdReadOnly` <- PrimeModelDetailsRetrieveResponseObject$`predictionThresholdReadOnly`
      self$`processes` <- ApiClient$new()$deserializeObj(PrimeModelDetailsRetrieveResponseObject$`processes`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`projectId` <- PrimeModelDetailsRetrieveResponseObject$`projectId`
      self$`ruleCount` <- PrimeModelDetailsRetrieveResponseObject$`ruleCount`
      self$`rulesetId` <- PrimeModelDetailsRetrieveResponseObject$`rulesetId`
      self$`samplePct` <- PrimeModelDetailsRetrieveResponseObject$`samplePct`
      self$`score` <- PrimeModelDetailsRetrieveResponseObject$`score`
      self$`supportsComposableMl` <- PrimeModelDetailsRetrieveResponseObject$`supportsComposableMl`
      self$`supportsMonotonicConstraints` <- PrimeModelDetailsRetrieveResponseObject$`supportsMonotonicConstraints`
      self$`trainingDuration` <- PrimeModelDetailsRetrieveResponseObject$`trainingDuration`
      self$`trainingEndDate` <- ParseRFC3339Timestamp(PrimeModelDetailsRetrieveResponseObject$`trainingEndDate`)
      self$`trainingRowCount` <- PrimeModelDetailsRetrieveResponseObject$`trainingRowCount`
      self$`trainingStartDate` <- ParseRFC3339Timestamp(PrimeModelDetailsRetrieveResponseObject$`trainingStartDate`)
