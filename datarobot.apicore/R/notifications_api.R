...
NotificationsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param namePart character. Only return the notification channels whose names contain the given substring.
    #' @param eventGroup Enum < [project.all, dataset.all, model_deployments.critical_health, model_deployments.health, model_deployments.management_agent, model_deployments.management_agent_health, prediction_request.all, challenger_management.all, challenger_replay.all, model_deployments.all, comment.all, perma_delete_project.all, users_delete.all, batch_predictions.all, applications.all, change_requests.all, monitoring.all] > Return policies with this event group.
    #' @param ... Optional. Additional named parameters to be passed downward.
