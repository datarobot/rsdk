...
ValidationChecks <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`combinedModelSegments` = NULL, `containsTrackedSegmentAttributes` = NULL, `featureDataTypes` = NULL, `features` = NULL, `humilityRules` = NULL, `modelCanBeDeployed` = NULL, `modelStatus` = NULL, `notCurrentModel` = NULL, `permission` = NULL, `predictionIntervals` = NULL, `predictionReady` = NULL, `seriesType` = NULL, `supported` = NULL, `target` = NULL, `targetClasses` = NULL, `targetType` = NULL, `timeSeriesCompatibility` = NULL, `validChallenger` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      requiredProps <- list()
      if (validateParams) {
        lapply(requiredProps, missing)
        private$validateProps(combinedModelSegments, containsTrackedSegmentAttributes, featureDataTypes, features, humilityRules, modelCanBeDeployed, modelStatus, notCurrentModel, permission, predictionIntervals, predictionReady, seriesType, supported, target, targetClasses, targetType, timeSeriesCompatibility, validChallenger)
      }
    ...
    validate = function() {
      props <- list(combinedModelSegments = self$`combinedModelSegments`, containsTrackedSegmentAttributes = self$`containsTrackedSegmentAttributes`, featureDataTypes = self$`featureDataTypes`, features = self$`features`, humilityRules = self$`humilityRules`, modelCanBeDeployed = self$`modelCanBeDeployed`, modelStatus = self$`modelStatus`, notCurrentModel = self$`notCurrentModel`, permission = self$`permission`, predictionIntervals = self$`predictionIntervals`, predictionReady = self$`predictionReady`, seriesType = self$`seriesType`, supported = self$`supported`, target = self$`target`, targetClasses = self$`targetClasses`, targetType = self$`targetType`, timeSeriesCompatibility = self$`timeSeriesCompatibility`, validChallenger = self$`validChallenger`)
