...
#'
#' @field type  character Section with user-defined content. Those sections may contain text generated by the user.
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SectionUser <- R6::R6Class(
  "SectionUser",
  lock_objects = FALSE,
  private = list(
  ...
  public = list(
    ...
    #' @param type Section with user-defined content. Those sections may contain text generated by the user.
    ...
    #' @param SectionUserJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(SectionUserJson, validateParams = FALSE) {
      SectionUserObject <- jsonlite::fromJSON(SectionUserJson)
      self$`description` <- SectionUserObject$`description`
      self$`highlightedText` <- SectionUserObject$`highlightedText`
      self$`instructions` <- InstructionsField$new()$fromJSON(jsonlite::toJSON(SectionUserObject$instructions, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`locked` <- SectionUserObject$`locked`
      self$`regularText` <- SectionUserObject$`regularText`
      self$`sections` <- ApiClient$new()$deserializeObj(SectionUserObject$`sections`, "array[object]", loadNamespace("datarobot.apicore"))
      self$`title` <- SectionUserObject$`title`
      self$`type` <- SectionUserObject$`type`
