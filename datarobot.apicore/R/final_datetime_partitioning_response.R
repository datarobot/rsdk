...
#' @docType class
#' @title FinalDatetimePartitioningResponse
#'
#' @description FinalDatetimePartitioningResponse Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field aggregationType  character For multiseries projects only. The aggregation type to apply when creating cross-series features.
#'
...
#'
#' @field availableTrainingRowCount  integer The number of rows in the available training data for scoring the holdout
#'
#' @field availableTrainingStartDate  character The start date of available training data for scoring the holdout.
#'
#' @field backtests  list( \link{FinalBacktestResponse} ) An array of the configured backtests.
#'
#' @field calendarId  character The ID of the calendar to be used in this project.
#'
#' @field calendarName  character The name of the calendar used in this project.
#'
#' @field crossSeriesGroupByColumns  list( character ) For multiseries projects with cross-series features enabled only. List of columns (currently of length 1). Setting that indicates how to further split series into related groups. For example, if every series is sales of an individual product, the series group-by could be the product category with values like \&quot;men&#39;s clothing\&quot;, \&quot;sports equipment\&quot;, etc.
#'
...
#'
#' @field gapRowCount  integer The number of rows in the gap between the training and holdout scoring data
#'
...
#'
#' @field holdoutRowCount  integer The number of rows in the holdout scoring data
#'
...
#'
#' @field modelSplits  integer Sets the cap on the number of jobs per model used when building models to control number of jobs in the queue. Higher number of modelSplits will allow for less downsampling leading to the use of more post-processed data.
#'
...
#'
#' @field partitioningExtendedWarnings  list( \link{PartitioningExtendedWarning} ) [optional] An array of available warnings about potential problems with the chosen partitioning that could cause issues during modeling, although the partitioning may be successfully submitted.
#'
...
#'
#' @field primaryTrainingRowCount  integer The number of rows in the primary training data for scoring the holdout
#'
...
#'
#' @field totalRowCount  integer The total number of rows in the project dataset
#'
...
#'
#' @field useCrossSeriesFeatures  character For multiseries projects only. Indicating whether to use cross-series features.
#'
...
#' @export
FinalDatetimePartitioningResponse <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(`aggregationType` = NULL, `autopilotDataSelectionMethod` = NULL, `availableTrainingDuration` = NULL, `availableTrainingEndDate` = NULL, `availableTrainingRowCount` = NULL, `availableTrainingStartDate` = NULL, `backtests` = NULL, `calendarId` = NULL, `calendarName` = NULL, `crossSeriesGroupByColumns` = NULL, `dateFormat` = NULL, `datetimePartitionColumn` = NULL, `defaultToAPriori` = NULL, `defaultToDoNotDerive` = NULL, `defaultToKnownInAdvance` = NULL, `differencingMethod` = NULL, `disableHoldout` = NULL, `featureDerivationWindowEnd` = NULL, `featureDerivationWindowStart` = NULL, `featureSettings` = NULL, `forecastWindowEnd` = NULL, `forecastWindowStart` = NULL, `gapDuration` = NULL, `gapEndDate` = NULL, `gapRowCount` = NULL, `gapStartDate` = NULL, `holdoutDuration` = NULL, `holdoutEndDate` = NULL, `holdoutRowCount` = NULL, `holdoutStartDate` = NULL, `isHoldoutModified` = NULL, `modelSplits` = NULL, `multiseriesIdColumns` = NULL, `numberOfBacktests` = NULL, `numberOfDoNotDeriveFeatures` = NULL, `numberOfKnownInAdvanceFeatures` = NULL, `partitioningExtendedWarnings` = NULL, `partitioningWarnings` = NULL, `periodicities` = NULL, `primaryTrainingDuration` = NULL, `primaryTrainingEndDate` = NULL, `primaryTrainingRowCount` = NULL, `primaryTrainingStartDate` = NULL, `projectId` = NULL, `totalRowCount` = NULL, `treatAsExponential` = NULL, `useCrossSeriesFeatures` = NULL, `useTimeSeries` = NULL, `validationDuration` = NULL, `windowsBasisUnit` = NULL) {
      ...
      if (!is.null(`holdoutRowCount`)) {
        stopifnot(is.numeric(`holdoutRowCount`), length(`holdoutRowCount`) == 1)
      }
  ...
  public = list(
    ...
    #' @param availableTrainingRowCount The number of rows in the available training data for scoring the holdout
    ...
    #' @param gapRowCount The number of rows in the gap between the training and holdout scoring data
    ...
    #' @param holdoutRowCount The number of rows in the holdout scoring data
    ...
    #' @param partitioningExtendedWarnings An array of available warnings about potential problems with the chosen partitioning that could cause issues during modeling, although the partitioning may be successfully submitted.
    ...
    #' @param primaryTrainingRowCount The number of rows in the primary training data for scoring the holdout
    #' @param primaryTrainingStartDate The start date of primary training data for scoring the holdout.
    #' @param projectId The ID of the project.
    #' @param totalRowCount The total number of rows in the project dataset
    ...
    initialize = function(`aggregationType` = NULL, `autopilotDataSelectionMethod` = NULL, `availableTrainingDuration` = NULL, `availableTrainingEndDate` = NULL, `availableTrainingRowCount` = NULL, `availableTrainingStartDate` = NULL, `backtests` = NULL, `calendarId` = NULL, `calendarName` = NULL, `crossSeriesGroupByColumns` = NULL, `dateFormat` = NULL, `datetimePartitionColumn` = NULL, `defaultToAPriori` = NULL, `defaultToDoNotDerive` = NULL, `defaultToKnownInAdvance` = NULL, `differencingMethod` = NULL, `disableHoldout` = NULL, `featureDerivationWindowEnd` = NULL, `featureDerivationWindowStart` = NULL, `featureSettings` = NULL, `forecastWindowEnd` = NULL, `forecastWindowStart` = NULL, `gapDuration` = NULL, `gapEndDate` = NULL, `gapRowCount` = NULL, `gapStartDate` = NULL, `holdoutDuration` = NULL, `holdoutEndDate` = NULL, `holdoutRowCount` = NULL, `holdoutStartDate` = NULL, `modelSplits` = NULL, `multiseriesIdColumns` = NULL, `numberOfBacktests` = NULL, `numberOfDoNotDeriveFeatures` = NULL, `numberOfKnownInAdvanceFeatures` = NULL, `partitioningWarnings` = NULL, `periodicities` = NULL, `primaryTrainingDuration` = NULL, `primaryTrainingEndDate` = NULL, `primaryTrainingRowCount` = NULL, `primaryTrainingStartDate` = NULL, `projectId` = NULL, `totalRowCount` = NULL, `treatAsExponential` = NULL, `useCrossSeriesFeatures` = NULL, `useTimeSeries` = NULL, `validationDuration` = NULL, `windowsBasisUnit` = NULL, `isHoldoutModified` = NULL, `partitioningExtendedWarnings` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      if (validateParams) {
        lapply(list(`aggregationType`, `autopilotDataSelectionMethod`, `availableTrainingDuration`, `availableTrainingEndDate`, `availableTrainingRowCount`, `availableTrainingStartDate`, `backtests`, `calendarId`, `calendarName`, `crossSeriesGroupByColumns`, `dateFormat`, `datetimePartitionColumn`, `defaultToAPriori`, `defaultToDoNotDerive`, `defaultToKnownInAdvance`, `differencingMethod`, `disableHoldout`, `featureDerivationWindowEnd`, `featureDerivationWindowStart`, `featureSettings`, `forecastWindowEnd`, `forecastWindowStart`, `gapDuration`, `gapEndDate`, `gapRowCount`, `gapStartDate`, `holdoutDuration`, `holdoutEndDate`, `holdoutRowCount`, `holdoutStartDate`, `modelSplits`, `multiseriesIdColumns`, `numberOfBacktests`, `numberOfDoNotDeriveFeatures`, `numberOfKnownInAdvanceFeatures`, `partitioningWarnings`, `periodicities`, `primaryTrainingDuration`, `primaryTrainingEndDate`, `primaryTrainingRowCount`, `primaryTrainingStartDate`, `projectId`, `totalRowCount`, `treatAsExponential`, `useCrossSeriesFeatures`, `useTimeSeries`, `validationDuration`, `windowsBasisUnit`), function(param) {
          stopifnot("Required param not set." = !is.null(param))
        })
        private$validateProps(aggregationType, autopilotDataSelectionMethod, availableTrainingDuration, availableTrainingEndDate, availableTrainingRowCount, availableTrainingStartDate, backtests, calendarId, calendarName, crossSeriesGroupByColumns, dateFormat, datetimePartitionColumn, defaultToAPriori, defaultToDoNotDerive, defaultToKnownInAdvance, differencingMethod, disableHoldout, featureDerivationWindowEnd, featureDerivationWindowStart, featureSettings, forecastWindowEnd, forecastWindowStart, gapDuration, gapEndDate, gapRowCount, gapStartDate, holdoutDuration, holdoutEndDate, holdoutRowCount, holdoutStartDate, isHoldoutModified, modelSplits, multiseriesIdColumns, numberOfBacktests, numberOfDoNotDeriveFeatures, numberOfKnownInAdvanceFeatures, partitioningExtendedWarnings, partitioningWarnings, periodicities, primaryTrainingDuration, primaryTrainingEndDate, primaryTrainingRowCount, primaryTrainingStartDate, projectId, totalRowCount, treatAsExponential, useCrossSeriesFeatures, useTimeSeries, validationDuration, windowsBasisUnit)
      }
      ...
      self$`holdoutRowCount` <- `holdoutRowCount`
    ...
    toJSON = function() {
      ...
      ',
        ...
        if (!is.null(self$`holdoutRowCount`)) {
          sprintf(
            '"holdoutRowCount":
            %d
                  ',
            self$`holdoutRowCount`
          )
        },
        ...
        if (!is.null(self$`partitioningExtendedWarnings`)) {
          sprintf(
            '"partitioningExtendedWarnings":
            [%s]
      ',
            paste(sapply(self$`partitioningExtendedWarnings`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox = TRUE, digits = NA)), collapse = ",")
          )
        },
    ...
    #' @param FinalDatetimePartitioningResponseJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(FinalDatetimePartitioningResponseJson, validateParams = FALSE) {
      FinalDatetimePartitioningResponseObject <- jsonlite::fromJSON(FinalDatetimePartitioningResponseJson)
      self$`aggregationType` <- FinalDatetimePartitioningResponseObject$`aggregationType`
      self$`autopilotDataSelectionMethod` <- FinalDatetimePartitioningResponseObject$`autopilotDataSelectionMethod`
      self$`availableTrainingDuration` <- FinalDatetimePartitioningResponseObject$`availableTrainingDuration`
      self$`availableTrainingEndDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`availableTrainingEndDate`)
      self$`availableTrainingRowCount` <- FinalDatetimePartitioningResponseObject$`availableTrainingRowCount`
      self$`availableTrainingStartDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`availableTrainingStartDate`)
      self$`backtests` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`backtests`, "array[FinalBacktestResponse]", loadNamespace("datarobot.apicore"))
      self$`calendarId` <- FinalDatetimePartitioningResponseObject$`calendarId`
      self$`calendarName` <- FinalDatetimePartitioningResponseObject$`calendarName`
      self$`crossSeriesGroupByColumns` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`crossSeriesGroupByColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`dateFormat` <- FinalDatetimePartitioningResponseObject$`dateFormat`
      self$`datetimePartitionColumn` <- FinalDatetimePartitioningResponseObject$`datetimePartitionColumn`
      self$`defaultToAPriori` <- FinalDatetimePartitioningResponseObject$`defaultToAPriori`
      self$`defaultToDoNotDerive` <- FinalDatetimePartitioningResponseObject$`defaultToDoNotDerive`
      self$`defaultToKnownInAdvance` <- FinalDatetimePartitioningResponseObject$`defaultToKnownInAdvance`
      self$`differencingMethod` <- FinalDatetimePartitioningResponseObject$`differencingMethod`
      self$`disableHoldout` <- FinalDatetimePartitioningResponseObject$`disableHoldout`
      self$`featureDerivationWindowEnd` <- FinalDatetimePartitioningResponseObject$`featureDerivationWindowEnd`
      self$`featureDerivationWindowStart` <- FinalDatetimePartitioningResponseObject$`featureDerivationWindowStart`
      self$`featureSettings` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`featureSettings`, "array[FeatureSetting]", loadNamespace("datarobot.apicore"))
      self$`forecastWindowEnd` <- FinalDatetimePartitioningResponseObject$`forecastWindowEnd`
      self$`forecastWindowStart` <- FinalDatetimePartitioningResponseObject$`forecastWindowStart`
      self$`gapDuration` <- FinalDatetimePartitioningResponseObject$`gapDuration`
      self$`gapEndDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`gapEndDate`)
      self$`gapRowCount` <- FinalDatetimePartitioningResponseObject$`gapRowCount`
      self$`gapStartDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`gapStartDate`)
      self$`holdoutDuration` <- FinalDatetimePartitioningResponseObject$`holdoutDuration`
      self$`holdoutEndDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`holdoutEndDate`)
      self$`holdoutRowCount` <- FinalDatetimePartitioningResponseObject$`holdoutRowCount`
      self$`holdoutStartDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`holdoutStartDate`)
      self$`isHoldoutModified` <- FinalDatetimePartitioningResponseObject$`isHoldoutModified`
      self$`modelSplits` <- FinalDatetimePartitioningResponseObject$`modelSplits`
      self$`multiseriesIdColumns` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`multiseriesIdColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`numberOfBacktests` <- FinalDatetimePartitioningResponseObject$`numberOfBacktests`
      self$`numberOfDoNotDeriveFeatures` <- FinalDatetimePartitioningResponseObject$`numberOfDoNotDeriveFeatures`
      self$`numberOfKnownInAdvanceFeatures` <- FinalDatetimePartitioningResponseObject$`numberOfKnownInAdvanceFeatures`
      self$`partitioningExtendedWarnings` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`partitioningExtendedWarnings`, "array[PartitioningExtendedWarning]", loadNamespace("datarobot.apicore"))
      self$`partitioningWarnings` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`partitioningWarnings`, "array[PartitioningWarning]", loadNamespace("datarobot.apicore"))
      self$`periodicities` <- ApiClient$new()$deserializeObj(FinalDatetimePartitioningResponseObject$`periodicities`, "array[Periodicity]", loadNamespace("datarobot.apicore"))
      self$`primaryTrainingDuration` <- FinalDatetimePartitioningResponseObject$`primaryTrainingDuration`
      self$`primaryTrainingEndDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`primaryTrainingEndDate`)
      self$`primaryTrainingRowCount` <- FinalDatetimePartitioningResponseObject$`primaryTrainingRowCount`
      self$`primaryTrainingStartDate` <- ParseRFC3339Timestamp(FinalDatetimePartitioningResponseObject$`primaryTrainingStartDate`)
      self$`projectId` <- FinalDatetimePartitioningResponseObject$`projectId`
      self$`totalRowCount` <- FinalDatetimePartitioningResponseObject$`totalRowCount`
      self$`treatAsExponential` <- FinalDatetimePartitioningResponseObject$`treatAsExponential`
      self$`useCrossSeriesFeatures` <- FinalDatetimePartitioningResponseObject$`useCrossSeriesFeatures`
      self$`useTimeSeries` <- FinalDatetimePartitioningResponseObject$`useTimeSeries`
      self$`validationDuration` <- FinalDatetimePartitioningResponseObject$`validationDuration`
      self$`windowsBasisUnit` <- FinalDatetimePartitioningResponseObject$`windowsBasisUnit`
