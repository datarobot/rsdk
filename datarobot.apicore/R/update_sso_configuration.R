...
#'
#' @description UpdateSsoConfiguration Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field advancedConfiguration  \link{SamlAdvancedConfiguration} [optional]
#'
...
#'
#' @field configurationType  character [optional] The type of the SSO configuration, defines the source of SSO metadata. It can be one of the following: &#x60;METADATA&#x60; - when IDP metadata is provided in the config, &#x60;METADATA_URL&#x60; - when an URL for metadata retrieval is provided in the config and &#x60;MANUAL&#x60; - when IDP sign-on/sign-out URLs and certificate are provided.
#'
#' @field enableSso  character [optional] Defines if SSO is enabled.
#'
#' @field enforceSso  character [optional] Defines if SSO is enforced.
#'
#' @field entityId  character [optional] The globally unique identifier of the entity. Provided by IdP service.
#'
...
#'
#' @field idpResponseMethod  character [optional] Identity provider response method, used to move user from IdP&#39;s authentication form back to the DataRobot side.
#'
#' @field issuer  character [optional] Optional Issuer field that may be required by IdP.
#'
#' @field name  character [optional] The name of the SSO configuration.
#'
...
#'
#' @field sessionLengthSeconds  integer [optional] Time window for the authentication session via IdP.
#'
#' @field signOnUrl  character [optional] URL to sign on via SSO.
#'
#' @field signOutUrl  character [optional] URL to sign out via SSO.
#'
#' @field spRequestMethod  character [optional] Service provider (DataRobot application) request method, is used to move user to the IdP&#39;s authentication form.
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
UpdateSsoConfiguration <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`advancedConfiguration` = NULL, `attributeMapping` = NULL, `autoGenerateUsers` = NULL, `certificate` = NULL, `configurationType` = NULL, `enableSso` = NULL, `enforceSso` = NULL, `entityId` = NULL, `groupMapping` = NULL, `idpMetadata` = NULL, `idpMetadataHttpsVerify` = NULL, `idpMetadataUrl` = NULL, `idpResponseMethod` = NULL, `issuer` = NULL, `name` = NULL, `organizationId` = NULL, `roleMapping` = NULL, `securityParameters` = NULL, `sessionLengthSeconds` = NULL, `signOnUrl` = NULL, `signOutUrl` = NULL, `spRequestMethod` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      if (validateParams) {
        lapply(list(), function(param) {
          stopifnot("Required param not set." = !is.null(param))
        })
        private$validateProps(advancedConfiguration, attributeMapping, autoGenerateUsers, certificate, configurationType, enableSso, enforceSso, entityId, groupMapping, idpMetadata, idpMetadataHttpsVerify, idpMetadataUrl, idpResponseMethod, issuer, name, organizationId, roleMapping, securityParameters, sessionLengthSeconds, signOnUrl, signOutUrl, spRequestMethod)
      }
    ...
    #' @param UpdateSsoConfigurationJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(UpdateSsoConfigurationJson, validateParams = FALSE) {
      UpdateSsoConfigurationObject <- jsonlite::fromJSON(UpdateSsoConfigurationJson)
      self$`advancedConfiguration` <- SamlAdvancedConfiguration$new()$fromJSON(jsonlite::toJSON(UpdateSsoConfigurationObject$advancedConfiguration, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`attributeMapping` <- SamlAttributeMapping$new()$fromJSON(jsonlite::toJSON(UpdateSsoConfigurationObject$attributeMapping, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`autoGenerateUsers` <- UpdateSsoConfigurationObject$`autoGenerateUsers`
      self$`certificate` <- SamlCertificate$new()$fromJSON(jsonlite::toJSON(UpdateSsoConfigurationObject$certificate, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`configurationType` <- UpdateSsoConfigurationObject$`configurationType`
      self$`enableSso` <- UpdateSsoConfigurationObject$`enableSso`
      self$`enforceSso` <- UpdateSsoConfigurationObject$`enforceSso`
      self$`entityId` <- UpdateSsoConfigurationObject$`entityId`
      self$`groupMapping` <- ApiClient$new()$deserializeObj(UpdateSsoConfigurationObject$`groupMapping`, "array[SamlGroupMapping]", loadNamespace("datarobot.apicore"))
      self$`idpMetadata` <- SamlMetadataFile$new()$fromJSON(jsonlite::toJSON(UpdateSsoConfigurationObject$idpMetadata, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`idpMetadataHttpsVerify` <- UpdateSsoConfigurationObject$`idpMetadataHttpsVerify`
      self$`idpMetadataUrl` <- UpdateSsoConfigurationObject$`idpMetadataUrl`
      self$`idpResponseMethod` <- UpdateSsoConfigurationObject$`idpResponseMethod`
      self$`issuer` <- UpdateSsoConfigurationObject$`issuer`
      self$`name` <- UpdateSsoConfigurationObject$`name`
      self$`organizationId` <- UpdateSsoConfigurationObject$`organizationId`
      self$`roleMapping` <- ApiClient$new()$deserializeObj(UpdateSsoConfigurationObject$`roleMapping`, "array[SamlRoleMapping]", loadNamespace("datarobot.apicore"))
      self$`securityParameters` <- SamlSecurityParameters$new()$fromJSON(jsonlite::toJSON(UpdateSsoConfigurationObject$securityParameters, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`sessionLengthSeconds` <- UpdateSsoConfigurationObject$`sessionLengthSeconds`
      self$`signOnUrl` <- UpdateSsoConfigurationObject$`signOnUrl`
      self$`signOutUrl` <- UpdateSsoConfigurationObject$`signOutUrl`
      self$`spRequestMethod` <- UpdateSsoConfigurationObject$`spRequestMethod`
