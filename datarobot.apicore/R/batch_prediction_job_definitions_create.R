...
#' @docType class
#' @title BatchPredictionJobDefinitionsCreate
#'
#' @description BatchPredictionJobDefinitionsCreate Class
#'
...
#'
#' @field intakeSettings  \link{OneOfAzureIntakeBigQueryIntakeDataStageIntakeCatalogDSSFileSystemIntakeGCPIntakeHTTPIntakeJDBCIntakeLocalFileIntakeS3IntakeSnowflakeIntakeSynapseIntake} The intake option configured for this job
#'
...
#' @export
BatchPredictionJobDefinitionsCreate <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`abortOnError` = NULL, `csvSettings` = NULL, `disableRowLevelErrorHandling` = NULL, `includePredictionStatus` = NULL, `includeProbabilities` = NULL, `includeProbabilitiesClasses` = NULL, `intakeSettings` = NULL, `maxExplanations` = NULL, `outputSettings` = NULL, `skipDriftTracking` = NULL, `chunkSize` = NULL, `columnNamesRemapping` = NULL, `deploymentId` = NULL, `enabled` = NULL, `explanationAlgorithm` = NULL, `explanationClassNames` = NULL, `explanationNumTopClasses` = NULL, `modelId` = NULL, `modelPackageId` = NULL, `name` = NULL, `numConcurrent` = NULL, `passthroughColumns` = NULL, `passthroughColumnsSet` = NULL, `pinnedModelId` = NULL, `predictionInstance` = NULL, `predictionWarningEnabled` = NULL, `schedule` = NULL, `thresholdHigh` = NULL, `thresholdLow` = NULL, `timeseriesSettings` = NULL, validateParams = FALSE, ...) {
    ...
    #' @param BatchPredictionJobDefinitionsCreateJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(BatchPredictionJobDefinitionsCreateJson, validateParams = FALSE) {
      BatchPredictionJobDefinitionsCreateObject <- jsonlite::fromJSON(BatchPredictionJobDefinitionsCreateJson)
      self$`abortOnError` <- BatchPredictionJobDefinitionsCreateObject$`abortOnError`
      self$`chunkSize` <- .setPrimitiveProperty(typeList = list("character", "numeric"), propertyData = BatchPredictionJobDefinitionsCreateObject$chunkSize)
      self$`columnNamesRemapping` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = BatchPredictionJobDefinitionsCreateObject$columnNamesRemapping)
      self$`csvSettings` <- BatchPredictionJobCSVSettings$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionsCreateObject$csvSettings, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`deploymentId` <- BatchPredictionJobDefinitionsCreateObject$`deploymentId`
      self$`disableRowLevelErrorHandling` <- BatchPredictionJobDefinitionsCreateObject$`disableRowLevelErrorHandling`
      self$`enabled` <- BatchPredictionJobDefinitionsCreateObject$`enabled`
      self$`explanationAlgorithm` <- BatchPredictionJobDefinitionsCreateObject$`explanationAlgorithm`
      self$`explanationClassNames` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionsCreateObject$`explanationClassNames`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`explanationNumTopClasses` <- BatchPredictionJobDefinitionsCreateObject$`explanationNumTopClasses`
      self$`includePredictionStatus` <- BatchPredictionJobDefinitionsCreateObject$`includePredictionStatus`
      self$`includeProbabilities` <- BatchPredictionJobDefinitionsCreateObject$`includeProbabilities`
      self$`includeProbabilitiesClasses` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionsCreateObject$`includeProbabilitiesClasses`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`intakeSettings` <- .setComplexProperty(typeList = list(AzureIntake, BigQueryIntake, DataStageIntake, Catalog, DSS, FileSystemIntake, GCPIntake, HTTPIntake, JDBCIntake, LocalFileIntake, S3Intake, SnowflakeIntake, SynapseIntake), propertyData = BatchPredictionJobDefinitionsCreateObject$intakeSettings)
      self$`maxExplanations` <- BatchPredictionJobDefinitionsCreateObject$`maxExplanations`
      self$`modelId` <- BatchPredictionJobDefinitionsCreateObject$`modelId`
      self$`modelPackageId` <- BatchPredictionJobDefinitionsCreateObject$`modelPackageId`
      self$`name` <- BatchPredictionJobDefinitionsCreateObject$`name`
      self$`numConcurrent` <- BatchPredictionJobDefinitionsCreateObject$`numConcurrent`
      self$`outputSettings` <- .setComplexProperty(typeList = list(AzureOutput, BigQueryOutput, FileSystemOutput, GCPOutput, HTTPOutput, JDBCOutput, LocalFileOutput, S3Output, SnowflakeOutput, SynapseOutput, Tableau), propertyData = BatchPredictionJobDefinitionsCreateObject$outputSettings)
      self$`passthroughColumns` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionsCreateObject$`passthroughColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`passthroughColumnsSet` <- BatchPredictionJobDefinitionsCreateObject$`passthroughColumnsSet`
      self$`pinnedModelId` <- BatchPredictionJobDefinitionsCreateObject$`pinnedModelId`
      self$`predictionInstance` <- BatchPredictionJobPredictionInstance$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionsCreateObject$predictionInstance, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`predictionWarningEnabled` <- BatchPredictionJobDefinitionsCreateObject$`predictionWarningEnabled`
      self$`schedule` <- Schedule$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionsCreateObject$schedule, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`skipDriftTracking` <- BatchPredictionJobDefinitionsCreateObject$`skipDriftTracking`
      self$`thresholdHigh` <- BatchPredictionJobDefinitionsCreateObject$`thresholdHigh`
      self$`thresholdLow` <- BatchPredictionJobDefinitionsCreateObject$`thresholdLow`
      self$`timeseriesSettings` <- .setComplexProperty(typeList = list(BatchPredictionJobTimeSeriesSettingsForecast, BatchPredictionJobTimeSeriesSettingsForecastWithPolicy, BatchPredictionJobTimeSeriesSettingsHistorical), propertyData = BatchPredictionJobDefinitionsCreateObject$timeseriesSettings)
