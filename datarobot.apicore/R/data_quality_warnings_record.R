...
DataQualityWarningsRecord <- R6::R6Class(
  ...
  public = list(
    ...
    validate = function() {
      do.call(private$validateProps, list(hasKiaMissingValuesInForecastWindow = self$`hasKiaMissingValuesInForecastWindow`, insufficientRowsForEvaluatingModels = self$`insufficientRowsForEvaluatingModels`, singleClassActualValueColumn = self$`singleClassActualValueColumn`))
    },
