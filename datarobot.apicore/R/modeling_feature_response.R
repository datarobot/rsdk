...
ModelingFeatureResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`dateFormat` = NULL, `featureLineageId` = NULL, `featureType` = NULL, `importance` = NULL, `lowInformation` = NULL, `max` = NULL, `mean` = NULL, `median` = NULL, `min` = NULL, `naCount` = NULL, `name` = NULL, `projectId` = NULL, `stdDev` = NULL, `targetLeakage` = NULL, `targetLeakageReason` = NULL, `dataQualities` = NULL, `isRestoredAfterReduction` = NULL, `isZeroInflated` = NULL, `keySummary` = NULL, `multilabelInsights` = NULL, `parentFeatureNames` = NULL, `uniqueCount` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`dateFormat`, `featureLineageId`, `featureType`, `importance`, `lowInformation`, `max`, `mean`, `median`, `min`, `naCount`, `name`, `projectId`, `stdDev`, `targetLeakage`, `targetLeakageReason`)
      if (validateParams) {
