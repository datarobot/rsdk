...
PerFeatureMissingReport <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`feature` = NULL, `missingCount` = NULL, `missingPercentage` = NULL, `tasks` = NULL, `type` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`feature`, `missingCount`, `missingPercentage`, `tasks`, `type`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(feature = self$`feature`, missingCount = self$`missingCount`, missingPercentage = self$`missingPercentage`, tasks = self$`tasks`, type = self$`type`)
