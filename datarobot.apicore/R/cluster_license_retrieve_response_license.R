...
ClusterLicenseRetrieveResponseLicense <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`concurrentWorkersCount` = NULL, `expirationTimestamp` = NULL, `expired` = NULL, `featureFlags` = NULL, `maxDeploymentLimit` = NULL, `maximumActiveUsers` = NULL, `prepaidDeploymentLimit` = NULL, validateParams = FALSE, ...) {
      ...
      if (validateParams) {
        lapply(list(`concurrentWorkersCount`, `expirationTimestamp`, `expired`, `featureFlags`, `maxDeploymentLimit`, `maximumActiveUsers`, `prepaidDeploymentLimit`), function(param) {
    ...
    validate = function() {
      do.call(private$validateProps, list(concurrentWorkersCount = self$`concurrentWorkersCount`, expirationTimestamp = self$`expirationTimestamp`, expired = self$`expired`, featureFlags = self$`featureFlags`, maxDeploymentLimit = self$`maxDeploymentLimit`, maximumActiveUsers = self$`maximumActiveUsers`, prepaidDeploymentLimit = self$`prepaidDeploymentLimit`))
    },
