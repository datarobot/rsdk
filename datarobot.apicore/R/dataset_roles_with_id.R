...
DatasetRolesWithId <- R6::R6Class(
  ...
  public = list(
    ...
    validate = function() {
      do.call(private$validateProps, list(canShare = self$`canShare`, canUseData = self$`canUseData`, id = self$`id`, role = self$`role`, shareRecipientType = self$`shareRecipientType`))
    },
