...
Constraints <- R6::R6Class(
  ...
  public = list(
    ...
    validate = function() {
      props <- list(ascii = self$`ascii`, float = self$`float`, floatList = self$`floatList`, int = self$`int`, intList = self$`intList`, select = self$`select`, selectgrid = self$`selectgrid`, unicode = self$`unicode`)
