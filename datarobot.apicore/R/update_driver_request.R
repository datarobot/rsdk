...
UpdateDriverRequest <- R6::R6Class(
  ...
  public = list(
    ...
    validate = function() {
      props <- list(baseNames = self$`baseNames`, canonicalName = self$`canonicalName`, className = self$`className`, configurationId = self$`configurationId`, localJarUrls = self$`localJarUrls`, removeConfig = self$`removeConfig`, skipConfigVerification = self$`skipConfigVerification`, version = self$`version`)
