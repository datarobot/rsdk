...
#' @docType class
#' @title PermutationFeatureImpactResponse
#'
#' @description PermutationFeatureImpactResponse Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field backtest  \link{OneOfintegerstring} The backtest model used to compute Feature Impact.Defined for datetime aware models.
#'
...
#' @export
PermutationFeatureImpactResponse <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(`backtest` = NULL, `count` = NULL, `featureImpacts` = NULL, `next_` = NULL, `previous` = NULL, `ranRedundancyDetection` = NULL, `rowCount` = NULL, `shapBased` = NULL) {
      if (!is.null(`backtest`)) {
  ...
  public = list(
    ...
    #' @param backtest The backtest model used to compute Feature Impact.Defined for datetime aware models.
    ...
    initialize = function(`backtest` = NULL, `count` = NULL, `featureImpacts` = NULL, `next_` = NULL, `previous` = NULL, `ranRedundancyDetection` = NULL, `rowCount` = NULL, `shapBased` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      if (validateParams) {
        lapply(list(`backtest`, `count`, `featureImpacts`, `next_`, `previous`, `ranRedundancyDetection`, `rowCount`, `shapBased`), function(param) {
          stopifnot("Required param not set." = !is.null(param))
        })
        private$validateProps(backtest, count, featureImpacts, next_, previous, ranRedundancyDetection, rowCount, shapBased)
      }
    ...
    validate = function() {
      do.call(private$validateProps, list(backtest = self$`backtest`, count = self$`count`, featureImpacts = self$`featureImpacts`, next_ = self$`next_`, previous = self$`previous`, ranRedundancyDetection = self$`ranRedundancyDetection`, rowCount = self$`rowCount`, shapBased = self$`shapBased`))
    },
    ...
    #' @param PermutationFeatureImpactResponseJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(PermutationFeatureImpactResponseJson, validateParams = FALSE) {
      PermutationFeatureImpactResponseObject <- jsonlite::fromJSON(PermutationFeatureImpactResponseJson)
      self$`backtest` <- .setPrimitiveProperty(typeList = list("numeric", "character"), propertyData = PermutationFeatureImpactResponseObject$backtest)
      self$`count` <- PermutationFeatureImpactResponseObject$`count`
      self$`featureImpacts` <- ApiClient$new()$deserializeObj(PermutationFeatureImpactResponseObject$`featureImpacts`, "array[FeatureImpactItem]", loadNamespace("datarobot.apicore"))
      self$`next_` <- PermutationFeatureImpactResponseObject$`next`
      self$`previous` <- PermutationFeatureImpactResponseObject$`previous`
      self$`ranRedundancyDetection` <- PermutationFeatureImpactResponseObject$`ranRedundancyDetection`
      self$`rowCount` <- PermutationFeatureImpactResponseObject$`rowCount`
      self$`shapBased` <- PermutationFeatureImpactResponseObject$`shapBased`
