...
#' @docType class
#' @title BatchPredictionJobDefinitionsUpdate
#'
#' @description BatchPredictionJobDefinitionsUpdate Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field abortOnError  character [optional] Should this job abort if too many errors are encountered
#'
...
#'
#' @field csvSettings  \link{BatchPredictionJobCSVSettings} [optional]
#'
#' @field deploymentId  character [optional] ID of deployment which is used in job for processing predictions dataset
#'
#' @field disableRowLevelErrorHandling  character [optional] Skip row by row error handling
#'
#' @field enabled  character [optional] If this job definition is enabled as a scheduled job. Optional if no schedule is supplied.
#'
...
#'
#' @field includePredictionStatus  character [optional] Include prediction status column in the output
#'
#' @field includeProbabilities  character [optional] Include probabilities for all classes
#'
#' @field includeProbabilitiesClasses  list( character ) [optional] Include only probabilities for these specific class names.
#'
#' @field intakeSettings  \link{OneOfAzureIntakeBigQueryIntakeDataStageIntakeCatalogDSSFileSystemIntakeGCPIntakeHTTPIntakeJDBCIntakeLocalFileIntakeS3IntakeSnowflakeIntakeSynapseIntake} [optional] The intake option configured for this job
#'
#' @field maxExplanations  integer [optional] Number of explanations requested. Will be ordered by strength.
#'
...
#'
#' @field name  character [optional] A human-readable name for the definition, must be unique across organisations, if left out the backend will generate one for you.
#'
#' @field numConcurrent  integer [optional] Number of simultaneous requests to run against the prediction instance
#'
#' @field outputSettings  \link{OneOfAzureOutputBigQueryOutputFileSystemOutputGCPOutputHTTPOutputJDBCOutputLocalFileOutputS3OutputSnowflakeOutputSynapseOutputTableau} [optional] The output option configured for this job
#'
...
#'
#' @field skipDriftTracking  character [optional] Skip drift tracking for this job.
#'
...
#'
#' @field timeseriesSettings  \link{OneOfBatchPredictionJobTimeSeriesSettingsForecastBatchPredictionJobTimeSeriesSettingsForecastWithPolicyBatchPredictionJobTimeSeriesSettingsHistorical} [optional] Time Series settings included of this job is a Time Series job.
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
BatchPredictionJobDefinitionsUpdate <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(`abortOnError` = NULL, `chunkSize` = NULL, `columnNamesRemapping` = NULL, `csvSettings` = NULL, `deploymentId` = NULL, `disableRowLevelErrorHandling` = NULL, `enabled` = NULL, `explanationAlgorithm` = NULL, `explanationClassNames` = NULL, `explanationNumTopClasses` = NULL, `includePredictionStatus` = NULL, `includeProbabilities` = NULL, `includeProbabilitiesClasses` = NULL, `intakeSettings` = NULL, `maxExplanations` = NULL, `modelId` = NULL, `modelPackageId` = NULL, `name` = NULL, `numConcurrent` = NULL, `outputSettings` = NULL, `passthroughColumns` = NULL, `passthroughColumnsSet` = NULL, `pinnedModelId` = NULL, `predictionInstance` = NULL, `predictionWarningEnabled` = NULL, `schedule` = NULL, `skipDriftTracking` = NULL, `thresholdHigh` = NULL, `thresholdLow` = NULL, `timeseriesSettings` = NULL) {
      ...
      if (!is.null(`includeProbabilitiesClasses`) && length(`includeProbabilitiesClasses`) > 0) {
        stopifnot(is.vector(`includeProbabilitiesClasses`), sapply(`includeProbabilitiesClasses`, is.character))
      }
      if (!is.null(`intakeSettings`)) {
        .setComplexProperty(typeList = list(AzureIntake, BigQueryIntake, DataStageIntake, Catalog, DSS, FileSystemIntake, GCPIntake, HTTPIntake, JDBCIntake, LocalFileIntake, S3Intake, SnowflakeIntake, SynapseIntake), propertyData = intakeSettings)
      }
      ...
      if (!is.null(`timeseriesSettings`)) {
        .setComplexProperty(typeList = list(BatchPredictionJobTimeSeriesSettingsForecast, BatchPredictionJobTimeSeriesSettingsForecastWithPolicy, BatchPredictionJobTimeSeriesSettingsHistorical), propertyData = timeseriesSettings)
      }
    }
  ),
  public = list(
    ...
    #' @param enabled If this job definition is enabled as a scheduled job. Optional if no schedule is supplied.
    ...
    #' @param name A human-readable name for the definition, must be unique across organisations, if left out the backend will generate one for you.
    ...
    initialize = function(`abortOnError` = TRUE, `chunkSize` = NULL, `columnNamesRemapping` = NULL, `csvSettings` = NULL, `deploymentId` = NULL, `disableRowLevelErrorHandling` = FALSE, `enabled` = NULL, `explanationAlgorithm` = NULL, `explanationClassNames` = NULL, `explanationNumTopClasses` = NULL, `includePredictionStatus` = FALSE, `includeProbabilities` = TRUE, `includeProbabilitiesClasses` = c(), `intakeSettings` = NULL, `maxExplanations` = 0, `modelId` = NULL, `modelPackageId` = NULL, `name` = NULL, `numConcurrent` = NULL, `outputSettings` = NULL, `passthroughColumns` = NULL, `passthroughColumnsSet` = NULL, `pinnedModelId` = NULL, `predictionInstance` = NULL, `predictionWarningEnabled` = NULL, `schedule` = NULL, `skipDriftTracking` = FALSE, `thresholdHigh` = NULL, `thresholdLow` = NULL, `timeseriesSettings` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      if (validateParams) {
        lapply(list(), function(param) {
          stopifnot("Required param not set." = !is.null(param))
        })
        private$validateProps(abortOnError, chunkSize, columnNamesRemapping, csvSettings, deploymentId, disableRowLevelErrorHandling, enabled, explanationAlgorithm, explanationClassNames, explanationNumTopClasses, includePredictionStatus, includeProbabilities, includeProbabilitiesClasses, intakeSettings, maxExplanations, modelId, modelPackageId, name, numConcurrent, outputSettings, passthroughColumns, passthroughColumnsSet, pinnedModelId, predictionInstance, predictionWarningEnabled, schedule, skipDriftTracking, thresholdHigh, thresholdLow, timeseriesSettings)
      }
      ...
      self$`intakeSettings` <- .setComplexProperty(typeList = list(AzureIntake, BigQueryIntake, DataStageIntake, Catalog, DSS, FileSystemIntake, GCPIntake, HTTPIntake, JDBCIntake, LocalFileIntake, S3Intake, SnowflakeIntake, SynapseIntake), propertyData = intakeSettings)
    ...
    #' @param BatchPredictionJobDefinitionsUpdateJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(BatchPredictionJobDefinitionsUpdateJson, validateParams = FALSE) {
      BatchPredictionJobDefinitionsUpdateObject <- jsonlite::fromJSON(BatchPredictionJobDefinitionsUpdateJson)
      self$`abortOnError` <- BatchPredictionJobDefinitionsUpdateObject$`abortOnError`
      self$`chunkSize` <- .setPrimitiveProperty(typeList = list("character", "numeric"), propertyData = BatchPredictionJobDefinitionsUpdateObject$chunkSize)
      self$`columnNamesRemapping` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = BatchPredictionJobDefinitionsUpdateObject$columnNamesRemapping)
      self$`csvSettings` <- BatchPredictionJobCSVSettings$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionsUpdateObject$csvSettings, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`deploymentId` <- BatchPredictionJobDefinitionsUpdateObject$`deploymentId`
      self$`disableRowLevelErrorHandling` <- BatchPredictionJobDefinitionsUpdateObject$`disableRowLevelErrorHandling`
      self$`enabled` <- BatchPredictionJobDefinitionsUpdateObject$`enabled`
      self$`explanationAlgorithm` <- BatchPredictionJobDefinitionsUpdateObject$`explanationAlgorithm`
      self$`explanationClassNames` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionsUpdateObject$`explanationClassNames`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`explanationNumTopClasses` <- BatchPredictionJobDefinitionsUpdateObject$`explanationNumTopClasses`
      self$`includePredictionStatus` <- BatchPredictionJobDefinitionsUpdateObject$`includePredictionStatus`
      self$`includeProbabilities` <- BatchPredictionJobDefinitionsUpdateObject$`includeProbabilities`
      self$`includeProbabilitiesClasses` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionsUpdateObject$`includeProbabilitiesClasses`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`intakeSettings` <- .setComplexProperty(typeList = list(AzureIntake, BigQueryIntake, DataStageIntake, Catalog, DSS, FileSystemIntake, GCPIntake, HTTPIntake, JDBCIntake, LocalFileIntake, S3Intake, SnowflakeIntake, SynapseIntake), propertyData = BatchPredictionJobDefinitionsUpdateObject$intakeSettings)
      self$`maxExplanations` <- BatchPredictionJobDefinitionsUpdateObject$`maxExplanations`
      self$`modelId` <- BatchPredictionJobDefinitionsUpdateObject$`modelId`
      self$`modelPackageId` <- BatchPredictionJobDefinitionsUpdateObject$`modelPackageId`
      self$`name` <- BatchPredictionJobDefinitionsUpdateObject$`name`
      self$`numConcurrent` <- BatchPredictionJobDefinitionsUpdateObject$`numConcurrent`
      self$`outputSettings` <- .setComplexProperty(typeList = list(AzureOutput, BigQueryOutput, FileSystemOutput, GCPOutput, HTTPOutput, JDBCOutput, LocalFileOutput, S3Output, SnowflakeOutput, SynapseOutput, Tableau), propertyData = BatchPredictionJobDefinitionsUpdateObject$outputSettings)
      self$`passthroughColumns` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionsUpdateObject$`passthroughColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`passthroughColumnsSet` <- BatchPredictionJobDefinitionsUpdateObject$`passthroughColumnsSet`
      self$`pinnedModelId` <- BatchPredictionJobDefinitionsUpdateObject$`pinnedModelId`
      self$`predictionInstance` <- BatchPredictionJobPredictionInstance$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionsUpdateObject$predictionInstance, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`predictionWarningEnabled` <- BatchPredictionJobDefinitionsUpdateObject$`predictionWarningEnabled`
      self$`schedule` <- Schedule$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionsUpdateObject$schedule, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`skipDriftTracking` <- BatchPredictionJobDefinitionsUpdateObject$`skipDriftTracking`
      self$`thresholdHigh` <- BatchPredictionJobDefinitionsUpdateObject$`thresholdHigh`
      self$`thresholdLow` <- BatchPredictionJobDefinitionsUpdateObject$`thresholdLow`
      self$`timeseriesSettings` <- .setComplexProperty(typeList = list(BatchPredictionJobTimeSeriesSettingsForecast, BatchPredictionJobTimeSeriesSettingsForecastWithPolicy, BatchPredictionJobTimeSeriesSettingsHistorical), propertyData = BatchPredictionJobDefinitionsUpdateObject$timeseriesSettings)
