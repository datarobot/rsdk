...
#' @docType class
#' @title BatchPredictionJobCreate
#'
#' @description BatchPredictionJobCreate Class
#'
...
#' @export
BatchPredictionJobCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param BatchPredictionJobCreateJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(BatchPredictionJobCreateJson, validateParams = FALSE) {
      BatchPredictionJobCreateObject <- jsonlite::fromJSON(BatchPredictionJobCreateJson)
      self$`abortOnError` <- BatchPredictionJobCreateObject$`abortOnError`
      self$`chunkSize` <- .setPrimitiveProperty(typeList = list("character", "numeric"), propertyData = BatchPredictionJobCreateObject$chunkSize)
      self$`columnNamesRemapping` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = BatchPredictionJobCreateObject$columnNamesRemapping)
      self$`csvSettings` <- BatchPredictionJobCSVSettings$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobCreateObject$csvSettings, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`deploymentId` <- BatchPredictionJobCreateObject$`deploymentId`
      self$`disableRowLevelErrorHandling` <- BatchPredictionJobCreateObject$`disableRowLevelErrorHandling`
      self$`explanationAlgorithm` <- BatchPredictionJobCreateObject$`explanationAlgorithm`
      self$`includePredictionStatus` <- BatchPredictionJobCreateObject$`includePredictionStatus`
      self$`includeProbabilities` <- BatchPredictionJobCreateObject$`includeProbabilities`
      self$`includeProbabilitiesClasses` <- ApiClient$new()$deserializeObj(BatchPredictionJobCreateObject$`includeProbabilitiesClasses`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`intakeSettings` <- .setComplexProperty(typeList = list(AzureIntake, BigQueryIntake, DataStageIntake, Catalog, DSS, FileSystemIntake, GCPIntake, HTTPIntake, JDBCIntake, LocalFileIntake, S3Intake, SnowflakeIntake, SynapseIntake), propertyData = BatchPredictionJobCreateObject$intakeSettings)
      self$`maxExplanations` <- BatchPredictionJobCreateObject$`maxExplanations`
      self$`modelId` <- BatchPredictionJobCreateObject$`modelId`
      self$`modelPackageId` <- BatchPredictionJobCreateObject$`modelPackageId`
      self$`numConcurrent` <- BatchPredictionJobCreateObject$`numConcurrent`
      self$`outputSettings` <- .setComplexProperty(typeList = list(AzureOutput, BigQueryOutput, FileSystemOutput, GCPOutput, HTTPOutput, JDBCOutput, LocalFileOutput, S3Output, SnowflakeOutput, SynapseOutput, Tableau), propertyData = BatchPredictionJobCreateObject$outputSettings)
      self$`passthroughColumns` <- ApiClient$new()$deserializeObj(BatchPredictionJobCreateObject$`passthroughColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`passthroughColumnsSet` <- BatchPredictionJobCreateObject$`passthroughColumnsSet`
      self$`pinnedModelId` <- BatchPredictionJobCreateObject$`pinnedModelId`
      self$`predictionInstance` <- BatchPredictionJobPredictionInstance$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobCreateObject$predictionInstance, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`predictionWarningEnabled` <- BatchPredictionJobCreateObject$`predictionWarningEnabled`
      self$`skipDriftTracking` <- BatchPredictionJobCreateObject$`skipDriftTracking`
      self$`thresholdHigh` <- BatchPredictionJobCreateObject$`thresholdHigh`
      self$`thresholdLow` <- BatchPredictionJobCreateObject$`thresholdLow`
      self$`timeseriesSettings` <- .setComplexProperty(typeList = list(BatchPredictionJobTimeSeriesSettingsForecast, BatchPredictionJobTimeSeriesSettingsHistorical), propertyData = BatchPredictionJobCreateObject$timeseriesSettings)
