...
BatchPredictionJobCreate <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSON = function(BatchPredictionJobCreateJson, validateParams = FALSE) {
      ...
      self$`explanationClassNames` <- ApiClient$new()$deserializeObj(BatchPredictionJobCreateObject$`explanationClassNames`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`explanationNumTopClasses` <- BatchPredictionJobCreateObject$`explanationNumTopClasses`
