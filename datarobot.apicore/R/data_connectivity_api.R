...
DataConnectivityApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param type Enum < [jdbc, dr-connector-v1, all] > Data source type to filter by.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' @param offset integer. Number of results to skip.
    #' @param limit integer. At most this many results are returned. The default may change without notice.
    #' @param type Enum < [jdbc, dr-connector-v1, all] > Includes only data stores of the specified type or any if set to &#x60;all&#x60;.
    ...
    #' \itemize{
    #' }
    #' \item **`422`** Filtering by database type is currently not supported for dr-connector-v1 data stores
    #' \itemize{
    #' }
    #' }
    #' @examples
    ...
    #' @param offset integer. Number of results to skip.
    #' @param limit integer. At most this many results are returned. The default may change without notice.
    #' @param type Enum < [jdbc, dr-connector-v1, all] > Type of driver configurations to return.
