...
DeploymentFeatureDriftResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`data` = NULL, `modelId` = NULL, `period` = NULL, `count` = NULL, `metric` = NULL, `next_` = NULL, `previous` = NULL, `segmentAttribute` = NULL, `segmentValue` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`data`, `modelId`, `period`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(count = self$`count`, data = self$`data`, metric = self$`metric`, modelId = self$`modelId`, next_ = self$`next_`, period = self$`period`, previous = self$`previous`, segmentAttribute = self$`segmentAttribute`, segmentValue = self$`segmentValue`)
