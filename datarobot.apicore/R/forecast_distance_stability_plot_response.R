...
ForecastDistanceStabilityPlotResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`endDate` = NULL, `forecastDistancePlotData` = NULL, `metricName` = NULL, `startDate` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`endDate`, `forecastDistancePlotData`, `metricName`, `startDate`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(endDate = self$`endDate`, forecastDistancePlotData = self$`forecastDistancePlotData`, metricName = self$`metricName`, startDate = self$`startDate`)
