...
AnomalyAssessmentExplanationsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`backtest` = NULL, `count` = NULL, `data` = NULL, `endDate` = NULL, `modelId` = NULL, `projectId` = NULL, `recordId` = NULL, `seriesId` = NULL, `shapBaseValue` = NULL, `source` = NULL, `startDate` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`backtest`, `count`, `data`, `endDate`, `modelId`, `projectId`, `recordId`, `seriesId`, `shapBaseValue`, `source`, `startDate`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(backtest = self$`backtest`, count = self$`count`, data = self$`data`, endDate = self$`endDate`, modelId = self$`modelId`, projectId = self$`projectId`, recordId = self$`recordId`, seriesId = self$`seriesId`, shapBaseValue = self$`shapBaseValue`, source = self$`source`, startDate = self$`startDate`)
