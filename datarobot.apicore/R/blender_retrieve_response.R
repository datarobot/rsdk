...
#'
#' @field featurelistId  character The ID of the featurelist used by the model. If null, the model was trained on multiple feature lists.
#'
...
#'
#' @field isFrozen  character Indicates whether the model is frozen, i.e. uses tuning parameters from a parent model
#'
...
#'
#' @field modelCategory  character Indicates what kind of model it is - will be &#x60;blend&#x60; for blenders.
#'
...
#'
#' @field modelType  character Identifies the model, e.g. &#x60;ENET Blender&#x60;.
#'
...
#'
#' @field processes  list( character ) A list of processes used by the model.
#'
...
#'
#' @field supportsMonotonicConstraints  character Whether this model supports enforcing montonic constraints.
#'
...
BlenderRetrieveResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param featurelistId The ID of the featurelist used by the model. If null, the model was trained on multiple feature lists.
    ...
    #' @param isFrozen Indicates whether the model is frozen, i.e. uses tuning parameters from a parent model
    ...
    #' @param modelCategory Indicates what kind of model it is - will be &#x60;blend&#x60; for blenders.
    ...
    #' @param modelType Identifies the model, e.g. &#x60;ENET Blender&#x60;.
    ...
    #' @param processes A list of processes used by the model.
    ...
    initialize = function(`blenderMethod` = NULL, `blueprintId` = NULL, `featurelistId` = NULL, `featurelistName` = NULL, `id` = NULL, `isFrozen` = NULL, `isStarred` = NULL, `linkFunction` = NULL, `metrics` = NULL, `modelCategory` = NULL, `modelFamily` = NULL, `modelIds` = NULL, `modelNumber` = NULL, `modelType` = NULL, `monotonicDecreasingFeaturelistId` = NULL, `monotonicIncreasingFeaturelistId` = NULL, `parentModelId` = NULL, `predictionThreshold` = NULL, `predictionThresholdReadOnly` = NULL, `processes` = NULL, `projectId` = NULL, `samplePct` = NULL, `supportsComposableMl` = NULL, `supportsMonotonicConstraints` = NULL, `trainingDuration` = NULL, `trainingEndDate` = NULL, `trainingRowCount` = NULL, `trainingStartDate` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`blenderMethod`, `blueprintId`, `featurelistId`, `featurelistName`, `id`, `isFrozen`, `isStarred`, `linkFunction`, `metrics`, `modelCategory`, `modelFamily`, `modelIds`, `modelNumber`, `modelType`, `monotonicDecreasingFeaturelistId`, `monotonicIncreasingFeaturelistId`, `parentModelId`, `predictionThreshold`, `predictionThresholdReadOnly`, `processes`, `projectId`, `samplePct`, `supportsComposableMl`, `supportsMonotonicConstraints`, `trainingDuration`, `trainingEndDate`, `trainingRowCount`, `trainingStartDate`)
      if (validateParams) {
