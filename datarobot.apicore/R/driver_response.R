...
DriverResponse <- R6::R6Class(
  ...
  public = list(
    ...
    validate = function() {
      props <- list(associatedAuthTypes = self$`associatedAuthTypes`, baseNames = self$`baseNames`, canonicalName = self$`canonicalName`, className = self$`className`, configurationId = self$`configurationId`, creator = self$`creator`, id = self$`id`, version = self$`version`)
