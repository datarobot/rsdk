...
ProjectsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' }
    ConfigureAndStartAutopilot = function(projectId, aim = NULL, ...) {
      apiResponse <- private$ConfigureAndStartAutopilotWithHttpInfo(projectId, aim, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @details This method invokes `DELETE /projects/{projectId}/featurelists/{featurelistId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID.
    ...
    #' @details This method invokes `PATCH /projects/{projectId}/featurelists/{featurelistId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID.
    #' @param featurelistId character. The featurelist ID.
    ...
    #' @details This method invokes `GET /projects/{projectId}/features/{featureName}/multiseriesProperties/` in the DataRobot Public API.
    ...
    #' @details This method invokes `DELETE /projects/{projectId}/modelingFeaturelists/{featurelistId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID.
    #' @param featurelistId character. The featurelist ID.
    #' @param dryRun Enum < [false, False, true, True] > Preview the deletion results without actually deleting the featurelist.
    #' @param deleteDependencies Enum < [false, False, true, True] > Automatically delete all dependencies of a featurelist. If false (default), will only delete the featurelist if it has no dependencies. The value of deleteDependencies will not be used if dryRun is true.If a featurelist has dependencies, deleteDependencies must be true for the request to succeed.
    ...
    #' @details This method invokes `PATCH /projects/{projectId}/modelingFeaturelists/{featurelistId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID.
    #' @param featurelistId character. The featurelist ID.
    #' @param updateFeaturelist \link{UpdateFeaturelist}.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' }
    SecondaryDatasetsConfigurationsList = function(projectId, featurelistId = NULL, modelId = NULL, offset = 0, limit = 100, includeDeleted = "false", ...) {
    ...
    #' @details This method invokes `POST /projects/{projectId}/typeTransformFeatures/` in the DataRobot Public API.
    #' @param projectId character. The project to create the feature in.
  ...
  private = list(
    ...
    # A helper function to invoke the API operation `ConfigureAndStartAutopilot`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ConfigureAndStartAutopilotWithHttpInfo = function(projectId, aim = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`aim`) && isa(aim, c("Aim", "R6"))) {
        ...
        stop("ConfigureAndStartAutopilotWithHttpInfo requires parameter aim to be of type Aim.")
      }
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    SecondaryDatasetsConfigurationsListWithHttpInfo = function(projectId, featurelistId = NULL, modelId = NULL, offset = 0, limit = 100, includeDeleted = "false", ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
