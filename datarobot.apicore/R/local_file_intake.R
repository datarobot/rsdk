...
#' @docType class
#' @title LocalFileIntake
#'
#' @description LocalFileIntake Class
#'
...
LocalFileIntake <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param LocalFileIntakeJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(LocalFileIntakeJson, validateParams = FALSE) {
      LocalFileIntakeObject <- jsonlite::fromJSON(LocalFileIntakeJson)
      self$`async` <- LocalFileIntakeObject$`async`
      self$`multipart` <- LocalFileIntakeObject$`multipart`
      self$`type` <- LocalFileIntakeObject$`type`
