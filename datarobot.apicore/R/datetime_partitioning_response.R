...
DatetimePartitioningResponse <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSON = function(DatetimePartitioningResponseJson, validateParams = FALSE) {
      ...
      self$`partitioningExtendedWarnings` <- ApiClient$new()$deserializeObj(DatetimePartitioningResponseObject$`partitioningExtendedWarnings`, "array[PartitioningExtendedWarning]", loadNamespace("datarobot.apicore"))
