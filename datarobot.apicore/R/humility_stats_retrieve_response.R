...
HumilityStatsRetrieveResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`data` = NULL, `period` = NULL, `modelId` = NULL, `segmentAttribute` = NULL, `segmentValue` = "", validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`data`, `period`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(data = self$`data`, modelId = self$`modelId`, period = self$`period`, segmentAttribute = self$`segmentAttribute`, segmentValue = self$`segmentValue`)
