...
#' @docType class
#' @title CustomTaskAccessControlResponse
#'
#' @description CustomTaskAccessControlResponse Class
#'
#' @format An \code{R6Class} generator object
#'
#' @field canShare  character Whether this user can share this custom task
#'
...
#' @export
CustomTaskAccessControlResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param canShare Whether this user can share this custom task
    ...
    #' @param CustomTaskAccessControlResponseJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(CustomTaskAccessControlResponseJson, validateParams = FALSE) {
      CustomTaskAccessControlResponseObject <- jsonlite::fromJSON(CustomTaskAccessControlResponseJson)
      self$`canShare` <- CustomTaskAccessControlResponseObject$`canShare`
      self$`role` <- CustomTaskAccessControlResponseObject$`role`
      self$`userId` <- CustomTaskAccessControlResponseObject$`userId`
      self$`username` <- CustomTaskAccessControlResponseObject$`username`
