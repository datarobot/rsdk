...
PayoffMatricesCreate <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`falseNegativeValue` = NULL, `falsePositiveValue` = NULL, `name` = NULL, `trueNegativeValue` = NULL, `truePositiveValue` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`falseNegativeValue`, `falsePositiveValue`, `name`, `trueNegativeValue`, `truePositiveValue`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(falseNegativeValue = self$`falseNegativeValue`, falsePositiveValue = self$`falsePositiveValue`, name = self$`name`, trueNegativeValue = self$`trueNegativeValue`, truePositiveValue = self$`truePositiveValue`)
