...
SsoConfigurationResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`configurationType` = NULL, `enableSso` = NULL, `enforceSso` = NULL, `entityId` = NULL, `id` = NULL, `idpResponseMethod` = NULL, `name` = NULL, `sessionLengthSeconds` = NULL, `spRequestMethod` = NULL, `attributeMapping` = NULL, `autoGenerateUsers` = NULL, `certificate` = NULL, `groupDelimiter` = NULL, `groupMapping` = NULL, `idpMetadata` = NULL, `idpMetadataHttpsVerify` = NULL, `idpMetadataUrl` = NULL, `issuer` = NULL, `organizationId` = NULL, `roleDelimiter` = NULL, `roleMapping` = NULL, `securityParameters` = NULL, `signOnUrl` = NULL, `signOutUrl` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`configurationType`, `enableSso`, `enforceSso`, `entityId`, `id`, `idpResponseMethod`, `name`, `sessionLengthSeconds`, `spRequestMethod`)
      if (validateParams) {
