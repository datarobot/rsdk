...
#'
#' @field autopilotMode  integer The current autopilot mode, either 0 for full autopilot or 2 for manual mode.
#'
...
#'
#' @field recommender  \link{ProjectRecommenderResponse}
#'
...
ProjectDetailsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param autopilotMode The current autopilot mode, either 0 for full autopilot or 2 for manual mode.
    ...
    fromJSON = function(ProjectDetailsResponseJson, validateParams = FALSE) {
      ...
      self$`recommender` <- ProjectRecommenderResponse$new()$fromJSON(jsonlite::toJSON(ProjectDetailsResponseObject$recommender, auto_unbox = TRUE, digits = NA, null = "null"))
