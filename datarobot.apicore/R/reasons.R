...
Reasons <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(supportsImageActivationMaps = NULL, supportsImageEmbedding = NULL) {
  ...
  public = list(
    ...
    initialize = function(`supportsImageActivationMaps` = NULL, `supportsImageEmbedding` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      requiredProps <- list()
      if (validateParams) {
        lapply(requiredProps, missing)
        private$validateProps(supportsImageActivationMaps, supportsImageEmbedding)
      }
    ...
    validate = function() {
      props <- list(supportsImageActivationMaps = self$`supportsImageActivationMaps`, supportsImageEmbedding = self$`supportsImageEmbedding`)
