...
#' @docType class
#' @title AdminSampleSize
#'
#' @description AdminSampleSize Class
#'
...
AdminSampleSize <- R6::R6Class(
  ...
  public = list(
    ...
    validate = function() {
      props <- list(type = self$`type`, value = self$`value`)
    ...
    #' @param AdminSampleSizeJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(AdminSampleSizeJson, validateParams = FALSE) {
      AdminSampleSizeObject <- jsonlite::fromJSON(AdminSampleSizeJson)
      self$`type` <- AdminSampleSizeObject$`type`
      self$`value` <- AdminSampleSizeObject$`value`
