...
FrequentValuesResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`frequentValues` = NULL, `name` = NULL, `numRows` = NULL, `projectId` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`frequentValues`, `name`, `numRows`, `projectId`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(frequentValues = self$`frequentValues`, name = self$`name`, numRows = self$`numRows`, projectId = self$`projectId`)
