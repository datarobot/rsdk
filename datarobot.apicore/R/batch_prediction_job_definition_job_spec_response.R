...
#' @docType class
#' @title BatchPredictionJobDefinitionJobSpecResponse
#'
#' @description BatchPredictionJobDefinitionJobSpecResponse Class
#'
...
#' @export
BatchPredictionJobDefinitionJobSpecResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param BatchPredictionJobDefinitionJobSpecResponseJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(BatchPredictionJobDefinitionJobSpecResponseJson, validateParams = FALSE) {
      BatchPredictionJobDefinitionJobSpecResponseObject <- jsonlite::fromJSON(BatchPredictionJobDefinitionJobSpecResponseJson)
      self$`abortOnError` <- BatchPredictionJobDefinitionJobSpecResponseObject$`abortOnError`
      self$`chunkSize` <- .setPrimitiveProperty(typeList = list("character", "numeric"), propertyData = BatchPredictionJobDefinitionJobSpecResponseObject$chunkSize)
      self$`columnNamesRemapping` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = BatchPredictionJobDefinitionJobSpecResponseObject$columnNamesRemapping)
      self$`csvSettings` <- BatchPredictionJobCSVSettings$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionJobSpecResponseObject$csvSettings, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`deploymentId` <- BatchPredictionJobDefinitionJobSpecResponseObject$`deploymentId`
      self$`disableRowLevelErrorHandling` <- BatchPredictionJobDefinitionJobSpecResponseObject$`disableRowLevelErrorHandling`
      self$`explanationAlgorithm` <- BatchPredictionJobDefinitionJobSpecResponseObject$`explanationAlgorithm`
      self$`includePredictionStatus` <- BatchPredictionJobDefinitionJobSpecResponseObject$`includePredictionStatus`
      self$`includeProbabilities` <- BatchPredictionJobDefinitionJobSpecResponseObject$`includeProbabilities`
      self$`includeProbabilitiesClasses` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionJobSpecResponseObject$`includeProbabilitiesClasses`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`intakeSettings` <- .setComplexProperty(typeList = list(DataStageDataStreamer, DSSDataStreamer, CatalogDataStreamer, FileSystemDataStreamer, HTTPDataStreamer, JDBCDataStreamer, LocalFileDataStreamer, AzureDataStreamer, GCPDataStreamer, BigQueryDataStreamer, S3DataStreamer, SnowflakeDataStreamer, SynapseDataStreamer), propertyData = BatchPredictionJobDefinitionJobSpecResponseObject$intakeSettings)
      self$`maxExplanations` <- BatchPredictionJobDefinitionJobSpecResponseObject$`maxExplanations`
      self$`modelId` <- BatchPredictionJobDefinitionJobSpecResponseObject$`modelId`
      self$`modelPackageId` <- BatchPredictionJobDefinitionJobSpecResponseObject$`modelPackageId`
      self$`numConcurrent` <- BatchPredictionJobDefinitionJobSpecResponseObject$`numConcurrent`
      self$`outputSettings` <- .setComplexProperty(typeList = list(FileSystemOutputAdaptor, HttpOutputAdaptor, JdbcOutputAdaptor, LocalFileOutputAdaptor, TableauOutputAdaptor, AzureOutputAdaptor, GCPOutputAdaptor, BigQueryOutputAdaptor, S3OutputAdaptor, SnowflakeOutputAdaptor, SynapseOutputAdaptor), propertyData = BatchPredictionJobDefinitionJobSpecResponseObject$outputSettings)
      self$`passthroughColumns` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionJobSpecResponseObject$`passthroughColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`passthroughColumnsSet` <- BatchPredictionJobDefinitionJobSpecResponseObject$`passthroughColumnsSet`
      self$`pinnedModelId` <- BatchPredictionJobDefinitionJobSpecResponseObject$`pinnedModelId`
      self$`predictionInstance` <- BatchPredictionJobPredictionInstance$new()$fromJSON(jsonlite::toJSON(BatchPredictionJobDefinitionJobSpecResponseObject$predictionInstance, auto_unbox = TRUE, digits = NA, null = "null"))
      self$`predictionWarningEnabled` <- BatchPredictionJobDefinitionJobSpecResponseObject$`predictionWarningEnabled`
      self$`skipDriftTracking` <- BatchPredictionJobDefinitionJobSpecResponseObject$`skipDriftTracking`
      self$`thresholdHigh` <- BatchPredictionJobDefinitionJobSpecResponseObject$`thresholdHigh`
      self$`thresholdLow` <- BatchPredictionJobDefinitionJobSpecResponseObject$`thresholdLow`
      self$`timeseriesSettings` <- .setComplexProperty(typeList = list(BatchPredictionJobTimeSeriesSettingsForecast, BatchPredictionJobTimeSeriesSettingsForecastWithPolicy, BatchPredictionJobTimeSeriesSettingsHistorical), propertyData = BatchPredictionJobDefinitionJobSpecResponseObject$timeseriesSettings)
