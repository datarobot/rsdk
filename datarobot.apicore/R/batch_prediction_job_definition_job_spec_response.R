...
BatchPredictionJobDefinitionJobSpecResponse <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSON = function(BatchPredictionJobDefinitionJobSpecResponseJson, validateParams = FALSE) {
      ...
      self$`explanationClassNames` <- ApiClient$new()$deserializeObj(BatchPredictionJobDefinitionJobSpecResponseObject$`explanationClassNames`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`explanationNumTopClasses` <- BatchPredictionJobDefinitionJobSpecResponseObject$`explanationNumTopClasses`
