...
FeatureImpactResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`count` = NULL, `featureImpacts` = NULL, `next_` = NULL, `previous` = NULL, `ranRedundancyDetection` = NULL, `rowCount` = NULL, `shapBased` = NULL, validateParams = FALSE, ...) {
      ...
      if (validateParams) {
        lapply(list(`count`, `featureImpacts`, `next_`, `previous`, `ranRedundancyDetection`, `rowCount`, `shapBased`), function(param) {
    ...
    validate = function() {
      do.call(private$validateProps, list(count = self$`count`, featureImpacts = self$`featureImpacts`, next_ = self$`next_`, previous = self$`previous`, ranRedundancyDetection = self$`ranRedundancyDetection`, rowCount = self$`rowCount`, shapBased = self$`shapBased`))
    },
