...
BiasVsAccuracyInsight <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`fairnessThreshold` = NULL, `models` = NULL, `accuracyMetric` = NULL, `fairnessMetric` = NULL, `protectedFeature` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`fairnessThreshold`, `models`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(accuracyMetric = self$`accuracyMetric`, fairnessMetric = self$`fairnessMetric`, fairnessThreshold = self$`fairnessThreshold`, models = self$`models`, protectedFeature = self$`protectedFeature`)
