...
CreateDriverRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`baseNames` = NULL, `localJarUrls` = NULL, `canonicalName` = NULL, `className` = NULL, `configurationId` = NULL, `version` = NULL, validateParams = FALSE, ...) {
      ...
      if (validateParams) {
        lapply(list(`baseNames`, `localJarUrls`), function(param) {
    ...
    validate = function() {
      do.call(private$validateProps, list(baseNames = self$`baseNames`, canonicalName = self$`canonicalName`, className = self$`className`, configurationId = self$`configurationId`, localJarUrls = self$`localJarUrls`, version = self$`version`))
    },
