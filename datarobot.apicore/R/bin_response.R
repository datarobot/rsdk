...
BinResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`avgPredicted` = NULL, `endDate` = NULL, `frequency` = NULL, `maxPredicted` = NULL, `startDate` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`avgPredicted`, `endDate`, `frequency`, `maxPredicted`, `startDate`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(avgPredicted = self$`avgPredicted`, endDate = self$`endDate`, frequency = self$`frequency`, maxPredicted = self$`maxPredicted`, startDate = self$`startDate`)
