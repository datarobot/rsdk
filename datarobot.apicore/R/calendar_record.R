...
CalendarRecord <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`created` = NULL, `datetimeFormat` = NULL, `earliestEvent` = NULL, `id` = NULL, `latestEvent` = NULL, `multiseriesIdColumns` = NULL, `name` = NULL, `numEventTypes` = NULL, `numEvents` = NULL, `projectId` = NULL, `role` = NULL, `source` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`created`, `datetimeFormat`, `earliestEvent`, `id`, `latestEvent`, `multiseriesIdColumns`, `name`, `numEventTypes`, `numEvents`, `projectId`, `role`, `source`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(created = self$`created`, datetimeFormat = self$`datetimeFormat`, earliestEvent = self$`earliestEvent`, id = self$`id`, latestEvent = self$`latestEvent`, multiseriesIdColumns = self$`multiseriesIdColumns`, name = self$`name`, numEventTypes = self$`numEventTypes`, numEvents = self$`numEvents`, projectId = self$`projectId`, role = self$`role`, source = self$`source`)
