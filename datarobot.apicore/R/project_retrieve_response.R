...
#'
#' @field automodelDeploymentId  character The ID of the Deployment that was created as the result of an Automodel on this project.  Null if there is no Automodel for the project
#'
...
#'
#' @field autopilotMode  character The current autopilot mode. 0: Full Autopilot. 2: Manual Mode. 4: Comprehenisve Autopilot. null: Mode not set. Note: Quick Autopilot is defined by the &#x60;quickrun&#x60; field.
#'
...
#'
#' @field quickrun  character If the Autopilot mode is set to quick.
#'
#' @field recommender  \link{Recommender}
#'
...
ProjectRetrieveResponse <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(advancedOptions = NULL, automodelDeploymentId = NULL, autopilotClusterList = NULL, autopilotMode = NULL, catalogId = NULL, catalogVersionId = NULL, created = NULL, externalTimeSeriesBaselineDatasetMetadata = NULL, featureEngineeringPredictionPoint = NULL, fileName = NULL, holdoutUnlocked = NULL, id = NULL, maxClusters = NULL, maxTrainPct = NULL, maxTrainRows = NULL, metric = NULL, minClusters = NULL, partition = NULL, positiveClass = NULL, primaryLocationColumn = NULL, projectName = NULL, queryGeneratorId = NULL, quickrun = NULL, recommender = NULL, segmentation = NULL, stage = NULL, target = NULL, targetType = NULL, unsupervisedMode = NULL, unsupervisedType = NULL, useFeatureDiscovery = NULL) {
      ...
      if (!is.null(`recommender`)) {
        stopifnot(R6::is.R6(`recommender`))
      }
      if (!is.null(`stage`)) {
  ...
  public = list(
    ...
    #' @param automodelDeploymentId The ID of the Deployment that was created as the result of an Automodel on this project.  Null if there is no Automodel for the project
    ...
    #' @param autopilotMode The current autopilot mode. 0: Full Autopilot. 2: Manual Mode. 4: Comprehenisve Autopilot. null: Mode not set. Note: Quick Autopilot is defined by the &#x60;quickrun&#x60; field.
    ...
    #' @param quickrun If the Autopilot mode is set to quick.
    #' @param recommender
    #' @param segmentation
    ...
    initialize = function(`advancedOptions` = NULL, `automodelDeploymentId` = NULL, `autopilotMode` = NULL, `catalogId` = NULL, `catalogVersionId` = NULL, `created` = NULL, `fileName` = NULL, `holdoutUnlocked` = NULL, `id` = NULL, `maxTrainPct` = NULL, `maxTrainRows` = NULL, `metric` = NULL, `partition` = NULL, `positiveClass` = NULL, `projectName` = NULL, `queryGeneratorId` = NULL, `quickrun` = NULL, `recommender` = NULL, `stage` = NULL, `target` = NULL, `targetType` = NULL, `unsupervisedMode` = NULL, `useFeatureDiscovery` = NULL, `autopilotClusterList` = NULL, `externalTimeSeriesBaselineDatasetMetadata` = NULL, `featureEngineeringPredictionPoint` = NULL, `maxClusters` = NULL, `minClusters` = NULL, `primaryLocationColumn` = NULL, `segmentation` = NULL, `unsupervisedType` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      requiredProps <- list(`advancedOptions`, `automodelDeploymentId`, `autopilotMode`, `catalogId`, `catalogVersionId`, `created`, `fileName`, `holdoutUnlocked`, `id`, `maxTrainPct`, `maxTrainRows`, `metric`, `partition`, `positiveClass`, `projectName`, `queryGeneratorId`, `quickrun`, `recommender`, `stage`, `target`, `targetType`, `unsupervisedMode`, `useFeatureDiscovery`)
      if (validateParams) {
        lapply(requiredProps, missing)
        private$validateProps(advancedOptions, automodelDeploymentId, autopilotClusterList, autopilotMode, catalogId, catalogVersionId, created, externalTimeSeriesBaselineDatasetMetadata, featureEngineeringPredictionPoint, fileName, holdoutUnlocked, id, maxClusters, maxTrainPct, maxTrainRows, metric, minClusters, partition, positiveClass, primaryLocationColumn, projectName, queryGeneratorId, quickrun, recommender, segmentation, stage, target, targetType, unsupervisedMode, unsupervisedType, useFeatureDiscovery)
      }
      self$`advancedOptions` <- `advancedOptions`
      self$`automodelDeploymentId` <- `automodelDeploymentId`
    ...
    validate = function() {
      props <- list(advancedOptions = self$`advancedOptions`, automodelDeploymentId = self$`automodelDeploymentId`, autopilotClusterList = self$`autopilotClusterList`, autopilotMode = self$`autopilotMode`, catalogId = self$`catalogId`, catalogVersionId = self$`catalogVersionId`, created = self$`created`, externalTimeSeriesBaselineDatasetMetadata = self$`externalTimeSeriesBaselineDatasetMetadata`, featureEngineeringPredictionPoint = self$`featureEngineeringPredictionPoint`, fileName = self$`fileName`, holdoutUnlocked = self$`holdoutUnlocked`, id = self$`id`, maxClusters = self$`maxClusters`, maxTrainPct = self$`maxTrainPct`, maxTrainRows = self$`maxTrainRows`, metric = self$`metric`, minClusters = self$`minClusters`, partition = self$`partition`, positiveClass = self$`positiveClass`, primaryLocationColumn = self$`primaryLocationColumn`, projectName = self$`projectName`, queryGeneratorId = self$`queryGeneratorId`, quickrun = self$`quickrun`, recommender = self$`recommender`, segmentation = self$`segmentation`, stage = self$`stage`, target = self$`target`, targetType = self$`targetType`, unsupervisedMode = self$`unsupervisedMode`, unsupervisedType = self$`unsupervisedType`, useFeatureDiscovery = self$`useFeatureDiscovery`)
    ...
    toJSON = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`automodelDeploymentId`)) {
          sprintf(
            '"automodelDeploymentId":
            "%s"
                  ',
            self$`automodelDeploymentId`
          )
        },
        ...
        if (!is.null(self$`recommender`)) {
          sprintf(
            '"recommender":
          %s
        ',
            jsonlite::toJSON(self$`recommender`$toJSON(), auto_unbox = TRUE, digits = NA)
          )
        },
    ...
    fromJSON = function(ProjectRetrieveResponseJson, validateParams = FALSE) {
      ...
      self$`automodelDeploymentId` <- ProjectRetrieveResponseObject$`automodelDeploymentId`
      ...
      self$`recommender` <- Recommender$new()$fromJSON(jsonlite::toJSON(ProjectRetrieveResponseObject$recommender, auto_unbox = TRUE, digits = NA, null = "null"))
