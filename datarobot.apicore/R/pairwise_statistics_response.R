...
PairwiseStatisticsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`data` = NULL, `featureName` = NULL, `projectId` = NULL, `statisticType` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`data`, `featureName`, `projectId`, `statisticType`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(data = self$`data`, featureName = self$`featureName`, projectId = self$`projectId`, statisticType = self$`statisticType`)
