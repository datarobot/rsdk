...
ModelPackageRetrieveResponse <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(activeDeploymentCount = NULL, capabilities = NULL, datasets = NULL, id = NULL, importMeta = NULL, isArchived = NULL, modelDescription = NULL, modelExecutionType = NULL, modelId = NULL, modelKind = NULL, name = NULL, permissions = NULL, sourceMeta = NULL, target = NULL, timeseries = NULL) {
  ...
  public = list(
    ...
    initialize = function(`activeDeploymentCount` = NULL, `capabilities` = NULL, `datasets` = NULL, `id` = NULL, `importMeta` = NULL, `isArchived` = NULL, `modelDescription` = NULL, `modelExecutionType` = NULL, `modelId` = NULL, `modelKind` = NULL, `name` = NULL, `permissions` = NULL, `sourceMeta` = NULL, `target` = NULL, `timeseries` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      requiredProps <- list(`activeDeploymentCount`, `capabilities`, `datasets`, `id`, `importMeta`, `isArchived`, `modelDescription`, `modelExecutionType`, `modelId`, `modelKind`, `name`, `permissions`, `sourceMeta`, `target`, `timeseries`)
      if (validateParams) {
        lapply(requiredProps, missing)
        private$validateProps(activeDeploymentCount, capabilities, datasets, id, importMeta, isArchived, modelDescription, modelExecutionType, modelId, modelKind, name, permissions, sourceMeta, target, timeseries)
      }
    ...
    validate = function() {
      props <- list(activeDeploymentCount = self$`activeDeploymentCount`, capabilities = self$`capabilities`, datasets = self$`datasets`, id = self$`id`, importMeta = self$`importMeta`, isArchived = self$`isArchived`, modelDescription = self$`modelDescription`, modelExecutionType = self$`modelExecutionType`, modelId = self$`modelId`, modelKind = self$`modelKind`, name = self$`name`, permissions = self$`permissions`, sourceMeta = self$`sourceMeta`, target = self$`target`, timeseries = self$`timeseries`)
