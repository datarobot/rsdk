...
#' @docType class
#' @title ModelDetailsResponse
#'
#' @description ModelDetailsResponse Class
#'
...
#' @export
ModelDetailsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param ModelDetailsResponseJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(ModelDetailsResponseJson, validateParams = FALSE) {
      ModelDetailsResponseObject <- jsonlite::fromJSON(ModelDetailsResponseJson)
      self$`blueprintId` <- ModelDetailsResponseObject$`blueprintId`
      self$`featurelistId` <- ModelDetailsResponseObject$`featurelistId`
      self$`featurelistName` <- ModelDetailsResponseObject$`featurelistName`
      self$`id` <- ModelDetailsResponseObject$`id`
      self$`isFrozen` <- ModelDetailsResponseObject$`isFrozen`
      self$`isStarred` <- ModelDetailsResponseObject$`isStarred`
      self$`linkFunction` <- ModelDetailsResponseObject$`linkFunction`
      self$`metrics` <- ModelDetailsResponseObject$`metrics`
      self$`modelCategory` <- ModelDetailsResponseObject$`modelCategory`
      self$`modelFamily` <- ModelDetailsResponseObject$`modelFamily`
      self$`modelType` <- ModelDetailsResponseObject$`modelType`
      self$`monotonicDecreasingFeaturelistId` <- ModelDetailsResponseObject$`monotonicDecreasingFeaturelistId`
      self$`monotonicIncreasingFeaturelistId` <- ModelDetailsResponseObject$`monotonicIncreasingFeaturelistId`
      self$`parentModelId` <- ModelDetailsResponseObject$`parentModelId`
      self$`predictionThreshold` <- ModelDetailsResponseObject$`predictionThreshold`
      self$`predictionThresholdReadOnly` <- ModelDetailsResponseObject$`predictionThresholdReadOnly`
      self$`processes` <- ApiClient$new()$deserializeObj(ModelDetailsResponseObject$`processes`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`projectId` <- ModelDetailsResponseObject$`projectId`
      self$`samplePct` <- ModelDetailsResponseObject$`samplePct`
      self$`supportsComposableMl` <- ModelDetailsResponseObject$`supportsComposableMl`
      self$`supportsMonotonicConstraints` <- ModelDetailsResponseObject$`supportsMonotonicConstraints`
      self$`trainingDuration` <- ModelDetailsResponseObject$`trainingDuration`
      self$`trainingEndDate` <- ParseRFC3339Timestamp(ModelDetailsResponseObject$`trainingEndDate`)
      self$`trainingRowCount` <- ModelDetailsResponseObject$`trainingRowCount`
      self$`trainingStartDate` <- ParseRFC3339Timestamp(ModelDetailsResponseObject$`trainingStartDate`)
