...
#' @docType class
#' @title DatasetRefresh
#'
#' @description DatasetRefresh Class
#'
...
#'
#' @field hour  \link{OneOfstringarray} [optional] The hour(s) of the day that the job will run. Allowed values are &#x60;&#x60;[0 ... 23]&#x60;&#x60;.
#'
#' @field minute  \link{OneOfstringarray} [optional] The minute(s) of the day that the job will run. Allowed values are &#x60;&#x60;[0 ... 59]&#x60;&#x60;.
#'
...
DatasetRefresh <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(`dayOfMonth` = NULL, `dayOfWeek` = NULL, `hour` = NULL, `minute` = NULL, `month` = NULL) {
      ...
      if (!is.null(`hour`)) {
        .setPrimitiveProperty(typeList = list("character", "array"), propertyData = hour)
      }
      if (!is.null(`minute`)) {
  ...
  public = list(
    ...
    #' @param hour The hour(s) of the day that the job will run. Allowed values are &#x60;&#x60;[0 ... 23]&#x60;&#x60;.
    #' @param minute The minute(s) of the day that the job will run. Allowed values are &#x60;&#x60;[0 ... 59]&#x60;&#x60;.
    ...
    initialize = function(`dayOfMonth` = c("*"), `dayOfWeek` = c("*"), `hour` = NULL, `minute` = NULL, `month` = c("*"), validateParams = FALSE, ...) {
      ...
      self$`hour` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = hour)
    ...
    #' @param DatasetRefreshJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(DatasetRefreshJson, validateParams = FALSE) {
      DatasetRefreshObject <- jsonlite::fromJSON(DatasetRefreshJson)
      self$`dayOfMonth` <- ApiClient$new()$deserializeObj(DatasetRefreshObject$`dayOfMonth`, "array[AnyOfnumberstring]", loadNamespace("datarobot.apicore"))
      self$`dayOfWeek` <- ApiClient$new()$deserializeObj(DatasetRefreshObject$`dayOfWeek`, "array[AnyOfnumberstring]", loadNamespace("datarobot.apicore"))
      self$`hour` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = DatasetRefreshObject$hour)
      self$`minute` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = DatasetRefreshObject$minute)
      self$`month` <- ApiClient$new()$deserializeObj(DatasetRefreshObject$`month`, "array[AnyOfnumberstring]", loadNamespace("datarobot.apicore"))
