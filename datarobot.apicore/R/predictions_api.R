...
PredictionsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' }
    BatchPredictionsList = function(offset, limit, allJobs, status = NULL, source = NULL, deploymentId = NULL, jobId = NULL, orderBy = NULL, cutoffHours = NULL, startDateTime = NULL, endDateTime = NULL, batchPredictionJobDefinitionId = NULL, hostname = NULL, intakeType = NULL, outputType = NULL, ...) {
      apiResponse <- private$BatchPredictionsListWithHttpInfo(offset, limit, allJobs, status, source, deploymentId, jobId, orderBy, cutoffHours, startDateTime, endDateTime, batchPredictionJobDefinitionId, hostname, intakeType, outputType, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Import a previously exported DRX model to be served by SSE
    #' Produces: "application/json"
    #'
    #' @details This route can be used on-prem to put a given DRX model into file storage so that it can be served by a Standalone Scoring Engine (SSE). Please note however that for this to work SSE needs to be configured to use the same file storage as the main Datarbot application (namely, Public API).
    #' @param singleModelFilePayload \link{SingleModelFilePayload}.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    ...
    #' }
    #' \item **`400`** Submitted DRX file is missing or invalid
    #' \itemize{
    #' }
    #' \item **`403`** Admin permissions required
    #' \itemize{
    #' }
    #' }
    #' @examples
    ...
    #' }
    ImportedModelsCreate = function(singleModelFilePayload = NULL, ...) {
      apiResponse <- private$ImportedModelsCreateWithHttpInfo(singleModelFilePayload, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Delete imported by from storage along with all its metadata
    #' Produces: "application/json"
    #'
    #' @details Delete previously imported DRX models from storage along with all its metadata. This deletion is permanent and cannot be reverted, but the one can export the original model and import it again.
    #' @param importId character. Unique identifier of the imported model
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`204`** Empty response means the model metadata was deleted successfully
    #' \itemize{
    #' }
    #' \item **`403`** Admin permissions required
    #' \itemize{
    #' }
    #' \item **`404`** Model does not exist or \&quot;ENABLE_BINARY_MODEL_IMPORT\&quot; is not enabled
    #' \itemize{
    #' }
    #' }
    #' @examples
    ...
    #' }
    ImportedModelsDelete = function(importId, ...) {
      apiResponse <- private$ImportedModelsDeleteWithHttpInfo(importId, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Lists imported models optionally filtering them by a string query
    #' Produces: "application/json"
    #'
    #' @details Lists imported models optionally filtering them by a string query.
    ...
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @return \link{ImportedModelListResponse}
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`200`** A list of imported models matching query (if any)
    #' \itemize{
    #' }
    #' \item **`400`** Invalid argument
    #' \itemize{
    #' }
    #' \item **`403`** Admin permissions required
    #' \itemize{
    ...
    #' }
    ImportedModelsList = function(offset, limit, query = NULL, ...) {
      apiResponse <- private$ImportedModelsListWithHttpInfo(offset, limit, query, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Allows updating some of the imported DRX model metadata fields
    #' Produces: "application/json"
    #'
    #' @details Update some of the imported DRX model metadata fields.
    #' @param importId character. Unique identifier of the imported model
    #' @param imortedModelUpdatePayload \link{ImortedModelUpdatePayload}.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`204`** Empty response means the model metadata was updated successfully
    #' \itemize{
    #' }
    #' \item **`403`** Admin permissions required
    #' \itemize{
    ...
    #' }
    ImportedModelsPatch = function(importId, imortedModelUpdatePayload = NULL, ...) {
      apiResponse <- private$ImportedModelsPatchWithHttpInfo(importId, imortedModelUpdatePayload, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Replace an already imported DRX model with a new one
    #' Produces: "application/json"
    #'
    #' @details Replace an already imported model. The model specified by &#x60;importId&#x60; will be replaced with the model binary provided and the old model will no longer be available at this location.
    #' @param importId character. Unique identifier of the imported model
    #' @param singleModelFilePayload \link{SingleModelFilePayload}.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    ...
    #' }
    ImportedModelsPut = function(importId, singleModelFilePayload = NULL, ...) {
      apiResponse <- private$ImportedModelsPutWithHttpInfo(importId, singleModelFilePayload, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Get imported DRX model details
    #' Produces: "application/json"
    #'
    #' @details Retrieve imported model metadata.
    #' @param importId character. Unique identifier of the imported model
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @return \link{ImportedModelRetrieveResponse}
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`200`** Imported DRX details
    #' \itemize{
    #' }
    #' \item **`403`** Admin permissions required
    #' \itemize{
    ...
    #' }
    ImportedModelsRetrieve = function(importId, ...) {
      apiResponse <- private$ImportedModelsRetrieveWithHttpInfo(importId, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' Produces: "application/json"
    #'
    #' @details Create a prediction dataset from a Dataset Item in the catalog.
    #' @param projectId character. The project ID.
    ...
    #' Produces: "application/json"
    #'
    #' @details Get a list of prediction records.  .. deprecated:: v2.21     Use :http:get:&#x60;/api/v2/projects/(projectId)/predictionsMetadata/&#x60; instead. The only     difference is that parameter &#x60;datasetId&#x60; is renamed to &#x60;predictionDatasetId&#x60;     both in request and response.
    #' @param offset integer. This many results will be skipped
  ...
  private = list(
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    BatchPredictionsListWithHttpInfo = function(offset, limit, allJobs, status = NULL, source = NULL, deploymentId = NULL, jobId = NULL, orderBy = NULL, cutoffHours = NULL, startDateTime = NULL, endDateTime = NULL, batchPredictionJobDefinitionId = NULL, hostname = NULL, intakeType = NULL, outputType = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    # A helper function to invoke the API operation `ImportedModelsCreate`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ImportedModelsCreateWithHttpInfo = function(singleModelFilePayload = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()

      if (!missing(`singleModelFilePayload`) && isa(singleModelFilePayload, c("SingleModelFilePayload", "R6"))) {
        body <- `singleModelFilePayload`$toJSON()
      } else {
        stop("ImportedModelsCreateWithHttpInfo requires parameter singleModelFilePayload to be of type SingleModelFilePayload.")
      }

      urlPath <- "/importedModels/"
    ...
    # A helper function to invoke the API operation `ImportedModelsDelete`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ImportedModelsDeleteWithHttpInfo = function(importId, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()

      if (missing(`importId`)) {
        stop("Missing required parameter `importId`.")
      }

      body <- NULL
      urlPath <- "/importedModels/{importId}/"
      if (!missing(`importId`)) {
        urlPath <- gsub(paste0("\\{", "importId", "\\}"), URLencode(as.character(`importId`), reserved = TRUE), urlPath)
      }
    ...
    # A helper function to invoke the API operation `ImportedModelsList`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ImportedModelsListWithHttpInfo = function(offset, limit, query = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- self$apiClient$deserialize(resp, "ImportedModelListResponse", loadNamespace("datarobot.apicore"))
        ApiResponse$new(deserializedRespObj, resp)
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
        ApiResponse$new(paste("Server returned ", httr::status_code(resp), " response status code. See $response for more detail."), resp)
      } else if (httr::status_code(resp) >= 400 && httr::status_code(resp) <= 499) {
    ...
    # A helper function to invoke the API operation `ImportedModelsPatch`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ImportedModelsPatchWithHttpInfo = function(importId, imortedModelUpdatePayload = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`imortedModelUpdatePayload`) && isa(imortedModelUpdatePayload, c("ImortedModelUpdatePayload", "R6"))) {
        body <- `imortedModelUpdatePayload`$toJSON()
      } else {
        stop("ImportedModelsPatchWithHttpInfo requires parameter imortedModelUpdatePayload to be of type ImortedModelUpdatePayload.")
      }
    ...
    # A helper function to invoke the API operation `ImportedModelsPut`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ImportedModelsPutWithHttpInfo = function(importId, singleModelFilePayload = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`singleModelFilePayload`) && isa(singleModelFilePayload, c("SingleModelFilePayload", "R6"))) {
        ...
        stop("ImportedModelsPutWithHttpInfo requires parameter singleModelFilePayload to be of type SingleModelFilePayload.")
      }
    ...
    # A helper function to invoke the API operation `ImportedModelsRetrieve`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ImportedModelsRetrieveWithHttpInfo = function(importId, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- self$apiClient$deserialize(resp, "ImportedModelRetrieveResponse", loadNamespace("datarobot.apicore"))
        ApiResponse$new(deserializedRespObj, resp)
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
        ApiResponse$new(paste("Server returned ", httr::status_code(resp), " response status code. See $response for more detail."), resp)
      } else if (httr::status_code(resp) >= 400 && httr::status_code(resp) <= 499) {
