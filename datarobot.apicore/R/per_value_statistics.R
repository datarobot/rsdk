...
PerValueStatistics <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`perValueStatistics` = NULL, `allOther` = NULL, `missingRowsPercent` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`perValueStatistics`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(allOther = self$`allOther`, missingRowsPercent = self$`missingRowsPercent`, perValueStatistics = self$`perValueStatistics`)
