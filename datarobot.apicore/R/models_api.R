...
ModelsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param customModelId character. ID of the custom model.
    #' @param deprecatedTrainingDataAssignment \link{DeprecatedTrainingDataAssignment}.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`202`** The request was accepted and will be worked on.
    ...
    #' }
    CustomModelsTrainingDataPatchMany = function(customModelId, deprecatedTrainingDataAssignment = NULL, ...) {
      apiResponse <- private$CustomModelsTrainingDataPatchManyWithHttpInfo(customModelId, deprecatedTrainingDataAssignment, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' }
    CustomModelsVersionsCreate = function(customModelId, isMajorUpdate, baseEnvironmentId = NULL, baseEnvironmentVersionId = NULL, desiredMemory = NULL, file = NULL, filePath = NULL, maximumMemory = NULL, networkEgressPolicy = NULL, replicas = NULL, requiredMetadata = NULL, requiredMetadataValues = NULL, requiresHa = NULL, ...) {
      apiResponse <- private$CustomModelsVersionsCreateWithHttpInfo(customModelId, isMajorUpdate, baseEnvironmentId, baseEnvironmentVersionId, desiredMemory, file, filePath, maximumMemory, networkEgressPolicy, replicas, requiredMetadata, requiredMetadataValues, requiresHa, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @param limit integer. At most this many results are returned.
    #' @param customModelId character. ID of the custom model.
    #' @param mainBranchCommitSha character. Specifies the commit SHA-1 in GitHub repository from the main branch that corresponds to a given custom model version.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' }
    CustomModelsVersionsList = function(offset, limit, customModelId, mainBranchCommitSha = NULL, ...) {
      apiResponse <- private$CustomModelsVersionsListWithHttpInfo(offset, limit, customModelId, mainBranchCommitSha, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' Produces: "application/json"
    #'
    #' @details Retrieve the capabilities for the model package.
    #' @details This method invokes `GET /modelPackages/{modelPackageId}/capabilities/` in the DataRobot Public API.
    #' @param modelPackageId character. ID of the model package.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @return \link{ModelPackageCapabilitiesRetrieveResponse}
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`200`**
    #' \itemize{
    ...
    #' }
    ModelPackagesCapabilitiesList = function(modelPackageId, ...) {
      apiResponse <- private$ModelPackagesCapabilitiesListWithHttpInfo(modelPackageId, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @param buildStatus Enum < [inProgress, complete, failed] > If specified, filter model packages by the build status.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' }
    ModelPackagesList = function(offset = 0, limit = 100, modelId = NULL, similarTo = NULL, forChallenger = NULL, search = NULL, predictionThreshold = NULL, imported = NULL, predictionEnvironmentId = NULL, modelKind = NULL, buildStatus = NULL, ...) {
      apiResponse <- private$ModelPackagesListWithHttpInfo(offset, limit, modelId, similarTo, forChallenger, search, predictionThreshold, imported, predictionEnvironmentId, modelKind, buildStatus, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Add a request to the queue to train a model with bias mitigation applied.
    #' Produces: NA
    #'
    #' @details Add a request to the queue to train a model with bias mitigation applied. If the job has been previously submitted, the request will return the jobId of the previously submitted job. Use this jobId to check status of the previously submitted job.
    ...
    #' @param biasMitigationModelCreate \link{BiasMitigationModelCreate}.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`202`** The model training request has been successfully submitted. See Location header.
    #' \itemize{
    #' }
    #' }
    #' @examples
    ...
    #' }
    ProjectsBiasMitigatedModelsCreate = function(projectId, biasMitigationModelCreate = NULL, ...) {
      apiResponse <- private$ProjectsBiasMitigatedModelsCreateWithHttpInfo(projectId, biasMitigationModelCreate, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description List of bias mitigated models for the selected project.
    #' Produces: "application/json"
    #'
    #' @details List of bias mitigated models for the selected project.
    #' @details This method invokes `GET /projects/{projectId}/biasMitigatedModels/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param offset integer. This many results will be skipped.
    #' @param limit integer. At most this many results are returned.
    #' @param parentModelId character. Retrieve a list of mitigated models for the parent model if specified. Otherwise retrieve a list of all mitigated models for the project.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @return \link{BiasMitigatedModelsListResponse}
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`200`** Returns Bias Mitigated models results.
    #' \itemize{
    #' }
    #' }
    #' @examples
    ...
    #' }
    ProjectsBiasMitigatedModelsList = function(projectId, offset = 0, limit = 100, parentModelId = NULL, ...) {
      apiResponse <- private$ProjectsBiasMitigatedModelsListWithHttpInfo(projectId, offset, limit, parentModelId, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Submit a job to create bias mitigation data quality information for a given projectId and featureName.
    #' Produces: NA
    #'
    #' @details Submit a job to create bias mitigation data quality information for a given projectId and featureName.
    #' @details This method invokes `POST /projects/{projectId}/biasMitigationFeatureInfo/{featureName}/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param featureName character. Name of feature for mitigation info.
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    ...
    #' }
    ProjectsBiasMitigationFeatureInfoCreateOne = function(projectId, featureName, ...) {
      apiResponse <- private$ProjectsBiasMitigationFeatureInfoCreateOneWithHttpInfo(projectId, featureName, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @description Get bias mitigation data quality information for a given projectId and featureName.
    #' Produces: "application/json"
    #'
    #' @details Get bias mitigation data quality information for a given projectId and featureName.
    #' @details This method invokes `GET /projects/{projectId}/biasMitigationFeatureInfo/` in the DataRobot Public API.
    #' @param featureName character. Name of feature for mitigation info.
    #' @param projectId character. The project ID
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @return \link{MessagesInfo}
    #' @details Response status codes, messages, and headers:
    #' \itemize{
    #' \item **`200`** Dictionary with one entry (\&quot;messages\&quot;) with list of data quality information about a feature.
    #' \itemize{
    #' }
    #' }
    #' @examples
    ...
    #' }
    ProjectsBiasMitigationFeatureInfoList = function(featureName, projectId, ...) {
      apiResponse <- private$ProjectsBiasMitigationFeatureInfoListWithHttpInfo(featureName, projectId, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @details This method invokes `POST /projects/{projectId}/datetimeModels/{modelId}/backtests/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    ...
    #' Produces: "application/json"
    #'
    #' @details Train a new datetime model.  All durations and datetimes should be specified in accordance with the &#x60;timestamp and duration formatting rules&lt;time_format&gt;&#x60;.
    ...
    #' Produces: "application/json"
    #'
    #' @details Look up a particular datetime model All durations and datetimes are specified in accordance with &#x60;timestamp and duration formatting rules &lt;time_format&gt;&#x60;.
    ...
    #' @details This method invokes `GET /projects/{projectId}/eureqaModels/{modelId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' @details This method invokes `POST /projects/{projectId}/frozenDatetimeModels/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    ...
    #' @details This method invokes `POST /projects/{projectId}/frozenModels/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    ...
    #' @details This method invokes `POST /projects/{projectId}/models/{modelId}/advancedTuning/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    ...
    #' @details This method invokes `GET /projects/{projectId}/models/{modelId}/advancedTuning/parameters/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' @details This method invokes `POST /projects/{projectId}/models/{modelId}/crossValidation/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param body object.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' @details This method invokes `GET /projects/{projectId}/models/{modelId}/crossValidationScores/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    ...
    #' @details This method invokes `DELETE /projects/{projectId}/models/{modelId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param ... Optional. Additional named parameters to be passed downward.
    #' @details Response status codes, messages, and headers:
    ...
    #' @details This method invokes `GET /projects/{projectId}/models/{modelId}/features/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' @details This method invokes `PATCH /projects/{projectId}/models/{modelId}/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    ...
    #' @details This method invokes `GET /projects/{projectId}/models/{modelId}/supportedCapabilities/` in the DataRobot Public API.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param ... Optional. Additional named parameters to be passed downward.
  ...
  private = list(
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    CustomModelsTrainingDataPatchManyWithHttpInfo = function(customModelId, deprecatedTrainingDataAssignment = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`deprecatedTrainingDataAssignment`) && isa(deprecatedTrainingDataAssignment, c("DeprecatedTrainingDataAssignment", "R6"))) {
        body <- `deprecatedTrainingDataAssignment`$toJSON()
      } else {
        stop("CustomModelsTrainingDataPatchManyWithHttpInfo requires parameter deprecatedTrainingDataAssignment to be of type DeprecatedTrainingDataAssignment.")
      }
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    CustomModelsVersionsCreateWithHttpInfo = function(customModelId, isMajorUpdate, baseEnvironmentId = NULL, baseEnvironmentVersionId = NULL, desiredMemory = NULL, file = NULL, filePath = NULL, maximumMemory = NULL, networkEgressPolicy = NULL, replicas = NULL, requiredMetadata = NULL, requiredMetadataValues = NULL, requiresHa = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    CustomModelsVersionsListWithHttpInfo = function(offset, limit, customModelId, mainBranchCommitSha = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      queryParams["mainBranchCommitSha"] <- mainBranchCommitSha
    ...
    # A helper function to invoke the API operation `ModelPackagesCapabilitiesList`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ModelPackagesCapabilitiesListWithHttpInfo = function(modelPackageId, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      body <- NULL
      urlPath <- "/modelPackages/{modelPackageId}/capabilities/"
      if (!missing(`modelPackageId`)) {
        urlPath <- gsub(paste0("\\{", "modelPackageId", "\\}"), URLencode(as.character(`modelPackageId`), reserved = TRUE), urlPath)
      }
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- self$apiClient$deserialize(resp, "ModelPackageCapabilitiesRetrieveResponse", loadNamespace("datarobot.apicore"))
        ApiResponse$new(deserializedRespObj, resp)
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
        ApiResponse$new(paste("Server returned ", httr::status_code(resp), " response status code. See $response for more detail."), resp)
      } else if (httr::status_code(resp) >= 400 && httr::status_code(resp) <= 499) {
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ModelPackagesListWithHttpInfo = function(offset = 0, limit = 100, modelId = NULL, similarTo = NULL, forChallenger = NULL, search = NULL, predictionThreshold = NULL, imported = NULL, predictionEnvironmentId = NULL, modelKind = NULL, buildStatus = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    # A helper function to invoke the API operation `ProjectsBiasMitigatedModelsCreate`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsBiasMitigatedModelsCreateWithHttpInfo = function(projectId, biasMitigationModelCreate = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`biasMitigationModelCreate`) && isa(biasMitigationModelCreate, c("BiasMitigationModelCreate", "R6"))) {
        body <- `biasMitigationModelCreate`$toJSON()
      } else {
        stop("ProjectsBiasMitigatedModelsCreateWithHttpInfo requires parameter biasMitigationModelCreate to be of type BiasMitigationModelCreate.")
      }

      urlPath <- "/projects/{projectId}/biasMitigatedModels/"
      if (!missing(`projectId`)) {
    ...
    # A helper function to invoke the API operation `ProjectsBiasMitigatedModelsList`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsBiasMitigatedModelsListWithHttpInfo = function(projectId, offset = 0, limit = 100, parentModelId = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- self$apiClient$deserialize(resp, "BiasMitigatedModelsListResponse", loadNamespace("datarobot.apicore"))
        ApiResponse$new(deserializedRespObj, resp)
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
        ApiResponse$new(paste("Server returned ", httr::status_code(resp), " response status code. See $response for more detail."), resp)
      } else if (httr::status_code(resp) >= 400 && httr::status_code(resp) <= 499) {
    ...
    # A helper function to invoke the API operation `ProjectsBiasMitigationFeatureInfoCreateOne`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsBiasMitigationFeatureInfoCreateOneWithHttpInfo = function(projectId, featureName, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      body <- NULL
      urlPath <- "/projects/{projectId}/biasMitigationFeatureInfo/{featureName}/"
      if (!missing(`projectId`)) {
        urlPath <- gsub(paste0("\\{", "projectId", "\\}"), URLencode(as.character(`projectId`), reserved = TRUE), urlPath)
      }
    ...
    # A helper function to invoke the API operation `ProjectsBiasMitigationFeatureInfoList`. This function is responsible for
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsBiasMitigationFeatureInfoListWithHttpInfo = function(featureName, projectId, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      body <- NULL
      urlPath <- "/projects/{projectId}/biasMitigationFeatureInfo/"
      if (!missing(`projectId`)) {
        urlPath <- gsub(paste0("\\{", "projectId", "\\}"), URLencode(as.character(`projectId`), reserved = TRUE), urlPath)
      }
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- self$apiClient$deserialize(resp, "MessagesInfo", loadNamespace("datarobot.apicore"))
        ApiResponse$new(deserializedRespObj, resp)
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
        ApiResponse$new(paste("Server returned ", httr::status_code(resp), " response status code. See $response for more detail."), resp)
      } else if (httr::status_code(resp) >= 400 && httr::status_code(resp) <= 499) {
