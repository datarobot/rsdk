...
InsightsApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' Produces: "application/json"
    #'
    #' @details Retrieve a plot displaying the stability of the datetime model across different backtests.  All durations and datetimes should be specified in accordance with the :ref:&#x60;timestamp and duration formatting rules&lt;time_format&gt;&#x60;.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    ...
    #' Produces: "application/json"
    #'
    #' @details Retrieve the metadata of the Accuracy Over Time (AOT) chart for an external dataset. Datetimes are specified in accordance with :ref:&#x60;timestamp and duration formatting rules &lt;time_format&gt;&#x60;.
    ...
    #' Produces: "application/json"
    #'
    #' @details Retrieve a preview of the Accuracy Over Time (AOT) chart for an external dataset. Datetimes are specified in accordance with :ref:&#x60;timestamp and duration formatting rules &lt;time_format&gt;&#x60;.
    #' @param projectId character. The project id which was used to compute the AOT chart.
    #' @param modelId character. The model id which was used to compute the AOT chart.
    #' @param datasetId character. The dataset id which was used to compute the AOT chart.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' Produces: "application/json"
    #'
    #' @details Retrieve the Accuracy Over Time (AOT) chart data for an external dataset for a project. Datetimes are specified in accordance with :ref:&#x60;timestamp and duration formatting rules &lt;time_format&gt;&#x60;.
    #' @param projectId character. The project id which was used to compute the AOT chart.
    #' @param modelId character. The model id which was used to compute the AOT chart.
    #' @param datasetId character. The dataset id which was used to compute the AOT chart.
    ...
    #' Produces: "application/json"
    #'
    #' @details Retrieve a plot displaying the stability of the time series model across different forecast distances. .. note::    All durations and datetimes are specified in accordance with the   :ref:&#x60;timestamp and duration formatting rules &lt;time_format&gt;&#x60;.
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param metricName character. The name of the metric to retrieve the scores for. If omitted, the default project metric will be used.
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' @param attribute Enum < [rowCount, duration, startDate, endDate, targetAverage, validationScore, backtestingScore, holdoutScore] > The series attribute to build a histogram for.
    ...
    #' @param filterBy Enum < [rowCount, startDate, endDate, targetAverage, validationScore, backtestingScore, holdoutScore] > Used to specify on which attribute values to filter the series.Supported attributes for filtering include: \&quot;rowCount\&quot;, \&quot;startDate\&quot;, \&quot;endDate\&quot;, \&quot;targetAverage\&quot;, \&quot;validationScore\&quot;, \&quot;holdoutScore\&quot;, and \&quot;backtestingScore\&quot;.&#x60;filterByBins&#x60; and &#x60;numberOfBins&#x60; are required if this parameter is used.
    ...
    #' }
    ProjectsDatetimeModelsMultiseriesScoresList = function(offset, limit, projectId, modelId, multiseriesValue = NULL, metric = NULL, orderBy = NULL, filterBy = NULL, numberOfBins = NULL, filterByBins = NULL, ...) {
      apiResponse <- private$ProjectsDatetimeModelsMultiseriesScoresListWithHttpInfo(offset, limit, projectId, modelId, multiseriesValue, metric, orderBy, filterBy, numberOfBins, filterByBins, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' }
    ProjectsModelsClusterInsightsDownloadList = function(projectId, modelId, format = "CSV", ...) {
      apiResponse <- private$ProjectsModelsClusterInsightsDownloadListWithHttpInfo(projectId, modelId, format, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param source Enum < [backtest_9, backtest_3, backtest_20, crossValidation, backtest_6, backtest_17, backtest_18, backtest_12, backtest_11, validation, backtest_10, backtest_16, backtest_15, backtest_8, backtest_19, backtest_5, backtest_13, backtest_2, backtest_4, backtest_14, holdout, backtest_7] > Source of the data
    #' @param ... Optional. Additional named parameters to be passed downward.
    ...
    #' }
    ProjectsModelsFeatureImpactCreate = function(projectId, modelId, featureImpactCreatePayload = NULL, ...) {
      apiResponse <- private$ProjectsModelsFeatureImpactCreateWithHttpInfo(projectId, modelId, featureImpactCreatePayload, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) == 202) {
        # When the DataRobot Public API returns a 202, this means that
        # an asynchronous job or task has been started. The response will
    ...
    #' @param projectId character. The project ID
    #' @param modelId character. The model ID
    #' @param backtest character. The backtest value is used for Feature Impact computation. It is possible to re-compute Feature Impact for different backtests in datetime partitioned models.
    #' @param ... Optional. Additional named parameters to be passed downward.
  ...
  private = list(
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsDatetimeModelsMultiseriesScoresListWithHttpInfo = function(offset, limit, projectId, modelId, multiseriesValue = NULL, metric = NULL, orderBy = NULL, filterBy = NULL, numberOfBins = NULL, filterByBins = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsModelsClusterInsightsDownloadListWithHttpInfo = function(projectId, modelId, format = "CSV", ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    # validating request parameters, building the request, deserializing the response, and handling errors.
    ProjectsModelsFeatureImpactCreateWithHttpInfo = function(projectId, modelId, featureImpactCreatePayload = NULL, ...) {
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      if (!missing(`featureImpactCreatePayload`) && isa(featureImpactCreatePayload, c("FeatureImpactCreatePayload", "R6"))) {
        ...
        stop("ProjectsModelsFeatureImpactCreateWithHttpInfo requires parameter featureImpactCreatePayload to be of type FeatureImpactCreatePayload.")
      }
