...
#' @docType class
#' @title CustomModelVersionCreateFromRepository
#'
#' @description CustomModelVersionCreateFromRepository Class
#'
...
#' @export
CustomModelVersionCreateFromRepository <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`repositoryId` = NULL, `baseEnvironmentId` = NULL, `isMajorUpdate` = TRUE, `ref` = NULL, `requiredMetadata` = NULL, `requiredMetadataValues` = NULL, `sourcePath` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`repositoryId`)
      if (validateParams) {
    ...
    validate = function() {
      props <- list(baseEnvironmentId = self$`baseEnvironmentId`, isMajorUpdate = self$`isMajorUpdate`, ref = self$`ref`, repositoryId = self$`repositoryId`, requiredMetadata = self$`requiredMetadata`, requiredMetadataValues = self$`requiredMetadataValues`, sourcePath = self$`sourcePath`)
...
',
    ...
    #' @param CustomModelVersionCreateFromRepositoryJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(CustomModelVersionCreateFromRepositoryJson, validateParams = FALSE) {
      CustomModelVersionCreateFromRepositoryObject <- jsonlite::fromJSON(CustomModelVersionCreateFromRepositoryJson)
      self$`baseEnvironmentId` <- CustomModelVersionCreateFromRepositoryObject$`baseEnvironmentId`
      self$`isMajorUpdate` <- CustomModelVersionCreateFromRepositoryObject$`isMajorUpdate`
      self$`ref` <- CustomModelVersionCreateFromRepositoryObject$`ref`
      self$`repositoryId` <- CustomModelVersionCreateFromRepositoryObject$`repositoryId`
      self$`requiredMetadata` <- CustomModelVersionCreateFromRepositoryObject$`requiredMetadata`
      self$`requiredMetadataValues` <- ApiClient$new()$deserializeObj(CustomModelVersionCreateFromRepositoryObject$`requiredMetadataValues`, "array[RequiredMetadataValue]", loadNamespace("datarobot.apicore"))
      self$`sourcePath` <- .setPrimitiveProperty(typeList = list("character", "array"), propertyData = CustomModelVersionCreateFromRepositoryObject$sourcePath)
