...
AiCatalogApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param type Enum < [user_blueprint, snapshot_dataset, remote_dataset, data_mesh_workspace, dataset] > Filter results by catalog type. The &#39;dataset&#39; option matches both &#39;snapshot_dataset&#39; and &#39;remote_dataset&#39;.
