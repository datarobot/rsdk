...
SeriesAccuracyRetrieveDataResponse <- R6::R6Class(
  ...
  private = list(
    ...
    validateProps = function(backtestingScore = NULL, duration = NULL, endDate = NULL, holdoutScore = NULL, multiseriesId = NULL, multiseriesValues = NULL, rowCount = NULL, startDate = NULL, targetAverage = NULL, validationScore = NULL) {
  ...
  public = list(
    ...
    initialize = function(`backtestingScore` = NULL, `duration` = NULL, `multiseriesId` = NULL, `multiseriesValues` = NULL, `rowCount` = NULL, `validationScore` = NULL, `endDate` = NULL, `holdoutScore` = NULL, `startDate` = NULL, `targetAverage` = NULL, validateParams = FALSE, ...) {
      local.optional.var <- list(...)
      requiredProps <- list(`backtestingScore`, `duration`, `multiseriesId`, `multiseriesValues`, `rowCount`, `validationScore`)
      if (validateParams) {
        lapply(requiredProps, missing)
        private$validateProps(backtestingScore, duration, endDate, holdoutScore, multiseriesId, multiseriesValues, rowCount, startDate, targetAverage, validationScore)
      }
    ...
    validate = function() {
      props <- list(backtestingScore = self$`backtestingScore`, duration = self$`duration`, endDate = self$`endDate`, holdoutScore = self$`holdoutScore`, multiseriesId = self$`multiseriesId`, multiseriesValues = self$`multiseriesValues`, rowCount = self$`rowCount`, startDate = self$`startDate`, targetAverage = self$`targetAverage`, validationScore = self$`validationScore`)
