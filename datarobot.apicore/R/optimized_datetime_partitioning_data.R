...
OptimizedDatetimePartitioningData <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`datetimePartitionColumn` = NULL, `aggregationType` = NULL, `allowPartialHistoryTimeSeriesPredictions` = FALSE, `autopilotClusterList` = NULL, `autopilotDataSelectionMethod` = NULL, `backtests` = NULL, `calendarId` = NULL, `crossSeriesGroupByColumns` = NULL, `defaultToAPriori` = NULL, `defaultToDoNotDerive` = NULL, `defaultToKnownInAdvance` = NULL, `differencingMethod` = NULL, `disableHoldout` = FALSE, `featureDerivationWindowEnd` = NULL, `featureDerivationWindowStart` = NULL, `featureSettings` = NULL, `forecastWindowEnd` = NULL, `forecastWindowStart` = NULL, `gapDuration` = NULL, `holdoutDuration` = NULL, `holdoutEndDate` = NULL, `holdoutStartDate` = NULL, `isHoldoutModified` = NULL, `modelSplits` = 5, `multiseriesIdColumns` = NULL, `numberOfBacktests` = NULL, `periodicities` = NULL, `target` = NULL, `treatAsExponential` = NULL, `unsupervisedMode` = FALSE, `unsupervisedType` = NULL, `useCrossSeriesFeatures` = FALSE, `useSupervisedFeatureReduction` = TRUE, `useTimeSeries` = FALSE, `validationDuration` = NULL, `windowsBasisUnit` = NULL, validateParams = FALSE, ...) {
      ...
      requiredProps <- list(`datetimePartitionColumn`)
      if (validateParams) {
