...
#' @docType class
#' @title OptimizedDatetimePartitioningData
#'
#' @description OptimizedDatetimePartitioningData Class
#'
...
#'
#' @field target  character [optional] Name of the target column.
#'
...
#' @export
OptimizedDatetimePartitioningData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param OptimizedDatetimePartitioningDataJson A JSON encoded string representation of a class instance.
    #' @param validateParams An optional param for auto validating this object's parameters after deserialization. Default FALSE.
    fromJSON = function(OptimizedDatetimePartitioningDataJson, validateParams = FALSE) {
      OptimizedDatetimePartitioningDataObject <- jsonlite::fromJSON(OptimizedDatetimePartitioningDataJson)
      self$`aggregationType` <- OptimizedDatetimePartitioningDataObject$`aggregationType`
      self$`allowPartialHistoryTimeSeriesPredictions` <- OptimizedDatetimePartitioningDataObject$`allowPartialHistoryTimeSeriesPredictions`
      self$`autopilotClusterList` <- ApiClient$new()$deserializeObj(OptimizedDatetimePartitioningDataObject$`autopilotClusterList`, "array[integer]", loadNamespace("datarobot.apicore"))
      self$`autopilotDataSelectionMethod` <- OptimizedDatetimePartitioningDataObject$`autopilotDataSelectionMethod`
      self$`backtests` <- ApiClient$new()$deserializeObj(OptimizedDatetimePartitioningDataObject$`backtests`, "array[OneOfBacktestOldMethodForOpenApiBacktestNewMethodForOpenApi]", loadNamespace("datarobot.apicore"))
      self$`calendarId` <- OptimizedDatetimePartitioningDataObject$`calendarId`
      self$`crossSeriesGroupByColumns` <- ApiClient$new()$deserializeObj(OptimizedDatetimePartitioningDataObject$`crossSeriesGroupByColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`datetimePartitionColumn` <- OptimizedDatetimePartitioningDataObject$`datetimePartitionColumn`
      self$`defaultToAPriori` <- OptimizedDatetimePartitioningDataObject$`defaultToAPriori`
      self$`defaultToDoNotDerive` <- OptimizedDatetimePartitioningDataObject$`defaultToDoNotDerive`
      self$`defaultToKnownInAdvance` <- OptimizedDatetimePartitioningDataObject$`defaultToKnownInAdvance`
      self$`differencingMethod` <- OptimizedDatetimePartitioningDataObject$`differencingMethod`
      self$`disableHoldout` <- OptimizedDatetimePartitioningDataObject$`disableHoldout`
      self$`featureDerivationWindowEnd` <- OptimizedDatetimePartitioningDataObject$`featureDerivationWindowEnd`
      self$`featureDerivationWindowStart` <- OptimizedDatetimePartitioningDataObject$`featureDerivationWindowStart`
      self$`featureSettings` <- ApiClient$new()$deserializeObj(OptimizedDatetimePartitioningDataObject$`featureSettings`, "array[FeatureSetting]", loadNamespace("datarobot.apicore"))
      self$`forecastWindowEnd` <- OptimizedDatetimePartitioningDataObject$`forecastWindowEnd`
      self$`forecastWindowStart` <- OptimizedDatetimePartitioningDataObject$`forecastWindowStart`
      self$`gapDuration` <- OptimizedDatetimePartitioningDataObject$`gapDuration`
      self$`holdoutDuration` <- OptimizedDatetimePartitioningDataObject$`holdoutDuration`
      self$`holdoutEndDate` <- ParseRFC3339Timestamp(OptimizedDatetimePartitioningDataObject$`holdoutEndDate`)
      self$`holdoutStartDate` <- ParseRFC3339Timestamp(OptimizedDatetimePartitioningDataObject$`holdoutStartDate`)
      self$`isHoldoutModified` <- OptimizedDatetimePartitioningDataObject$`isHoldoutModified`
      self$`modelSplits` <- OptimizedDatetimePartitioningDataObject$`modelSplits`
      self$`multiseriesIdColumns` <- ApiClient$new()$deserializeObj(OptimizedDatetimePartitioningDataObject$`multiseriesIdColumns`, "array[character]", loadNamespace("datarobot.apicore"))
      self$`numberOfBacktests` <- OptimizedDatetimePartitioningDataObject$`numberOfBacktests`
      self$`periodicities` <- ApiClient$new()$deserializeObj(OptimizedDatetimePartitioningDataObject$`periodicities`, "array[Periodicity]", loadNamespace("datarobot.apicore"))
      self$`target` <- OptimizedDatetimePartitioningDataObject$`target`
      self$`treatAsExponential` <- OptimizedDatetimePartitioningDataObject$`treatAsExponential`
      self$`unsupervisedMode` <- OptimizedDatetimePartitioningDataObject$`unsupervisedMode`
      self$`unsupervisedType` <- OptimizedDatetimePartitioningDataObject$`unsupervisedType`
      self$`useCrossSeriesFeatures` <- OptimizedDatetimePartitioningDataObject$`useCrossSeriesFeatures`
      self$`useSupervisedFeatureReduction` <- OptimizedDatetimePartitioningDataObject$`useSupervisedFeatureReduction`
      self$`useTimeSeries` <- OptimizedDatetimePartitioningDataObject$`useTimeSeries`
      self$`validationDuration` <- OptimizedDatetimePartitioningDataObject$`validationDuration`
      self$`windowsBasisUnit` <- OptimizedDatetimePartitioningDataObject$`windowsBasisUnit`
