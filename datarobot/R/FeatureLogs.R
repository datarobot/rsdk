...
#' @name DownloadTimeSeriesFeatureDerivationLog
#' @details Download the time series feature derivation log as a text file.
#'
...
#' @name GetTimeSeriesFeatureDerivationLog
#' @details Retrieve the time series feature derivation log content
#'
