...
#' @name CreateFeaturelist
#' @details Create a new featurelist in a DataRobot project
#'
...
#' @name CreateModelingFeaturelist
#' @details This function allows the user to create a new featurelist
#' in a project by specifying its name and a list of variables
#' to be included
#'
...
#' @name GetFeaturelist
#' @details Retrieve a specific featurelist from a DataRobot project
#'
...
#' @name GetModelingFeaturelist
#' @details Retrieve a specific modeling featurelist from a DataRobot project
#'
#' In time series projects, a new set of modeling features is created after setting the
#' partitioning options. These features are automatically derived from those in the project's
#' dataset and are the features used for modeling. Modeling features are only accessible once
...
#' @name ListFeaturelists
#' @details Retrieve all featurelists associated with a project
#'
...
#' @name ListModelingFeaturelists
#' @details Retrieve all modeling featurelists associated with a project
#'
#' In time series projects, a new set of modeling features is created after setting the
#' partitioning options. These features are automatically derived from those in the project's
#' dataset and are the features used for modeling. Modeling features are only accessible once
