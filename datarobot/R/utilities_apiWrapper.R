...
#' @details This method invokes `POST /stringEncryptions/` in the DataRobot Public API.
#'
#' @param ... Additional keyword arguments to be passed on to the `datarobot.apicore` and `httr` libraries.
#'
#' @seealso The method StringEncryptionsCreate in [datarobot.apicore::UtilitiesApi], which invokes the same underlying API endpoint.
#' @export
#' @md
