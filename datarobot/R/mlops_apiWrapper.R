...
#'
#' @seealso The method MlopsPortablePredictionServerImageList in [datarobot.apicore::MlopsApi], which this function wraps.
#' @family Mlops
#' @export
...
#' Fetches currently active PPS Docker image metadata
#'
#' @seealso The method MlopsPortablePredictionServerImageMetadataList in [datarobot.apicore::MlopsApi], which this function wraps.
#' @family Mlops
#' @export
